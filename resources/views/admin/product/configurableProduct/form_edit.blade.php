                    ...
                    <form role="form" action="{{route('edit_product', [base64_encode(1),base64_encode($id)])}}" method="post" enctype="multipart/form-data">
							...
							<form role="form" action="{{route('edit_product', [base64_encode(3),base64_encode($id)])}}" method="post" enctype="multipart/form-data">
							  @csrf
								...
								<div class="row">
                                <div class="col-md-2">
                                     {!! App\Helpers\CustomFormHelper::getskuHtml($page_details["Form_data"]["Form_field"]["product_atr_sku_field"],$attr['sku']); !!}
                                </div>
								<div class="col-md-2">
								...
								<div class="col-md-1 hideElement">
...
$color_images=DB::table('product_configuration_images')
						...
						$imagespathfolder='uploads/products/'.$page_details["return_data"]["vendor_id"].'/'.$attr['sku'];
						//print_r($imagespathfolder);
                                    ...
                                    <div class="col-md-10">
										 ...
										 <div id="recipeCarousel{{@$attr['color_id']}}" class="recipeCarousel carousel slide" data-ride="carousel" data-type="multi" data-interval="false" >
											...
											<?php $a = 1; ?>
												...
												<?php 
													//print_r($row->product_config_image);
												?>
												<div class="carousel-item <?php echo ($a==1)?'active':''; ?>">
													<div class="col-md-2">
													 <!--<img class="img-fluid" src="{{URL::to('/uploads/products')}}/{{$row->product_config_image}}">-->
													 {!! App\Helpers\CustomFormHelper::support_image($imagespathfolder,$row->product_config_image); !!}
													 <?php if(count($color_images) > 1){ ?>
        ...
        >{{$extra_option->filter_value}}</option>
            ...
            @endforeach
								...
								@endif
									...
									<h4 class="hideElement" ><label for="exampleInputEmail1">Legal Information</label></h4>
