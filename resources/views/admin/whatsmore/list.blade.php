...
<div class="">
	<div class="allbutntbl">
		<a href="{{ route('addmy_offers') }}" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add My Offers</a>
	</div>
	<!--<div class="col-sm-12">
		<div class="row">
			<div class="col-sm-2">
					...
					<tbody>
					  ...
					  @foreach($Whatsmore as $Blog)
						...
						<tr>
							...
							<td>
							<a href="{{route('my_offers_sts',[base64_encode($Blog->id),base64_encode($Blog->status)] )}}"
									...
									&nbsp;|&nbsp;
							<a href="{{route('editmy_offers', base64_encode($Blog->id))}}">
								<i class="fa fa-pencil text-blue" aria-hidden="true"></i>
								</a>&nbsp; | &nbsp;
							<a href="{{route('deletemy_offers', base64_encode($Blog->id))}}"
