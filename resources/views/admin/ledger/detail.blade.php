						...
						str_replace('--','/',$daterange):"";?>">
							...
							<div class="col-md-1" style="padding:0px;" >
								<div class="searchmain">
									...
									<button type="submit" class="btn btn-primary ledgerDetails reportFilter" >Search</button>
								</div>
							</div>
						</div>
				  ...
				  <div class="mailbox-read-message">
					...
					<?php $i=1; $total_commission=0; ?>
					  ...
					  ?>
						...
						<?php
						 $total+=(int)$row['product_qty']*(int)$row['product_price'];
						//  print_r($row['product_qty']);exit;
								$total_commission+=(int)$commission_amt;
								// $commission_amt++;
						?>
					    @endforeach
