...
<div class="">
	...
	<div class="col-sm-12">
		<div class="row">
		    	<div class="col-sm-12 text-right mb15">
				...
				<input type="text" name="daterange" class="form-control daterange" placeholder="Select Date" value="<?php echo ($daterange!='All')? str_replace('.','/',$daterange):"";?>">
					...
					<div class="col-md-5">
						<div class="searchmain">
							<input type="text" name="search_string" id="vendorsearch_string" class="form-control " placeholder="Search by payment mode" value="<?php echo ($str!='All')? $str:"";?>">
							<button type="submit" class="btn btn-primary payment_historyreportFilter"  >Search</button>
						</div>
					</div>
				</div>
