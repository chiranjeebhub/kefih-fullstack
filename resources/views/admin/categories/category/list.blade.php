...
<div class="">
	...
	<div class="col-sm-12">
		<div class="row">
			...
			<div class="col-sm-9">
				<div class="row">
					<div class="col-md-4 hidden-xs"><a href="{{ $page_details['export']}}" class="btn btn-warning">Export TO CSV</a> &nbsp; </div>
					...
					<div class="col-md-5 col-xs-12">
						<div class="searchmain">
							<input type="text" name="search_string" class="form-control search_string"  placeholder="Search by category name" value="{{$parameters}}">
        ...
        $last_index= count($final_cats)-1;
         ...
         foreach($final_cats as $final){
			...
			{{$span}}
							...
							<?php } ?>
							<a href="{{route('categorywisesizechart', base64_encode($Category->id))}}">Size chart</a>
							</td>
