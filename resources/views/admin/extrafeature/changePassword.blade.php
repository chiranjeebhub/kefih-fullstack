	...
	<div class="row">
		...
		<div class="col-sm-6">
			<div class="form-group">
				<label for="exampleInputEmail1">New Email (if you want to change email)</label> 
				<input type="email" name="email" value="" class="form-control" id="change_email" placeholder="New Email">
			</div>
		</div>
