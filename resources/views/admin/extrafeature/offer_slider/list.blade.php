...
@section('content')
		...
		<?php 
				...
				// $url="https://b2cdomain.in/kefih/admin/offer_slider/".$parameters_level;
				$url="https://b2cdomain.in/kefih/all-products/slider ".($parameters_level+1)."/".$parameters_level;
				
				// echo $url,Request::segment(3);
				// // die;
?>
...
<nav class="mt15">
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
	...
	<a class="nav-item nav-link  <?php echo ($parameters_level==0)?'active':''; ?>"  href="{{ route('offer_slider',base64_encode(0)) }}">Slider 1 </a>
	<a class="nav-item nav-link <?php echo ($parameters_level==1)?'active':''; ?>"  href="{{ route('offer_slider',base64_encode(1)) }}">Slider 2</a>
	<a class="nav-item nav-link <?php echo ($parameters_level==2)?'active':''; ?>"  href="{{ route('offer_slider',base64_encode(2)) }}">Slider 3</a>
	<a class="nav-item nav-link <?php echo ($parameters_level==3)?'active':''; ?>"  href="{{ route('offer_slider',base64_encode(3)) }}">Slider 4</a>
	<!-- <a class="nav-item nav-link <?php echo ($parameters_level==5)?'active':''; ?>"  href="{{ route('offer_slider',base64_encode(5)) }}">Offer Going on</a> -->
