					...
					@if(!empty($vendors))
					  ...
					  ?>
						...
						<tr>
							...
							&nbsp; | &nbsp;	
							@if($vendor->featuremart == '1')
							<a class="btn shadow-box btn-success" href="{{ route('vendornotfeaturemart', $vendor->id ) }}" >Featured</a>
							
							@else
							<a class="btn shadow-box btn-success" href="{{ route('vendorfeaturemart', $vendor->id ) }}">Mark as Featured</a>
							@endif
							<a class="btn shadow-box btn-success" href="{{ route('admincategories', $vendor->id ) }}">Add size chart</a>
							</td>
