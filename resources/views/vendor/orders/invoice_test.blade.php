    ...
    <div style="width:100%; margin-left:auto; margin-right:auto;padding: 0;">
		...
		<tr>
			<td style="padding: 10px; text-align: left; background: #fff">
				<table cellpadding="5px" cellspacing="0" style="width: 100%; border: solid 1px #737373; font-size: 12px;">
					<tr bgcolor="#ebecec">
					  	<th style="border-right: solid 1px #737373; font-size: 18px; width: 50%; padding-left: 5px;">Sold by</th>
					  	<th>&nbsp;</th>
					</tr>
					<tr>
						<td style="border-right: solid 1px #737373; padding-left: 5px;">Sold By : {{$vdr_data['company_name']}}</td>
					  	<td style=" padding-left: 5px;">Invoice Date : @if($Order[0]['order_detail_invoice_date']!='') {{ date('d-m-Y',strtotime($Order[0]['order_detail_invoice_date']))}} @endif
						</td>
					</tr>
					<tr>
					...
					<tr>
					  	<td style="border-right: solid 1px #737373; padding-left: 5px;">Pin : {{$vdr_data['company_pincode']}} </td>
                        <td style=" padding-left: 5px;">&nbsp;</td>
					</tr>
					<?php if($vdr_data['gst_no']!=''){?>
					<tr>
					  	<td style="border-right: solid 1px #737373; padding-left: 5px;">GSTIN :  {{$vdr_data['gst_no']}}</td>
					    <td style=" padding-left: 5px;">&nbsp;</td>
					</tr>
					<?php } ?>
					<tr>
				...
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #737373; border-top:none; font-size: 12px;">
					<tr bgcolor="#ebecec">
					  	<th style="border-right: solid 1px #737373; font-size: 18px; width: 50%; padding-left: 5px;">Shipping Address</th>
					  	<th style="font-size: 18px; padding-left: 5px;">Billing Address</th>
					</tr>
					<tr>
					...
					<!--<tr bgcolor="#ebecec">
					  	<th style="border-right: solid 1px #737373; font-size: 14px; padding-left: 5px;">Dispatched Via. XXXXX</th>
					  	<th style="font-size: 14px; padding-left: 5px;">Dispatched Doc. No. (AWB) XXXXXXX</th>
					</tr>-->
				</table>
					<br/>
				...
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #000333; font-size: 14px;">
					<tr bgcolor="#ebecec">
						...
						<!--<th style="border-right: solid 1px #000333; font-size: 14px; padding-left: 5px; font-weight: normal;">MRP Price(Rs.)</th>-->
						<!-- <th style="border-right: solid 1px #000333; font-size: 14px;">Selling Price(Rs.)</th> -->
						<!--<th style="border-right: solid 1px #000333; font-size: 14px; padding-left: 5px; font-weight: normal;">Discount(Rs.)</th>-->
						<?php if($vdr_data['gst_no']!=''){?>
					...
					?>
					<tr>
						<td style="border-right: solid 1px #000333; padding-left: 5px;">
						...
						<!--<td style=" padding-left: 5px; border-right: solid 1px #000333;">{{($row['product_price_old'])?number_format($row['product_price_old'],2):''}}</td>-->
						<!-- <td style="border-right: solid 1px #000333;">{{number_format($row['product_price'],2)}}</td> -->
						<!--<td style=" padding-left: 5px; border-right: solid 1px #000333;">{{($row['product_price_old'])?number_format(($row['product_price_old']-$row['product_price']),2):''}}</td>-->
						<?php if($vdr_data['gst_no']!=''){?>
					...
					<!--<tr>
					  	<td style="border-right: solid 1px #000333; padding-left: 5px;">warranty</td>
					  	<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
					...
					<tr>
					  	<td style="border-right: solid 1px #000333; padding-left: 5px;">IGST</td>
					  	<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
					...
					<tr>
						<td style="border-right: solid 1px #000333; padding-left: 5px;"><br/></td>
						<td style="border-right: solid 1px #000333; padding-left: 5px;"><br/></td>
						<!--<td style="border-right: solid 1px #000333; padding-left: 5px;"><br/></td>
						<td style="border-right: solid 1px #000333; padding-left: 5px;"><br/></td>-->
						<!-- <td style="border-right: solid 1px #000333; padding-left: 5px;"><br/></td> -->
					...
					<tr>
					  	<td style="border-right: solid 1px #000333; padding-left: 5px; font-weight: bold;">Shipping Charges</td>
					  	<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
						<!--<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>-->
						<!-- <td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td> -->
						...
						<td style=" padding-left: 5px; border-right: solid 1px #000333;">&nbsp;</td>
						<?php }?>
						<td style=" padding-left: 5px;">{{($row['order_cod_charges']!=0)?$row['order_cod_charges']:'Free'}}</td>
					</tr>-->
					...
					@endforeach
					<tr>
					  	<td style="border-right: solid 1px #000333; border-top: solid 1px #000333; font-size: 14px; padding-left: 5px; font-weight: bold;">Sub Total</td>
					...
					<tr>
					  	<td style="border-right: solid 1px #000333; border-top: solid 1px #000333; font-size: 14px; padding-left: 5px; font-weight: bold;">Slot Charges</td>
					  	<td style="font-size: 14px; padding-left: 5px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td>
						<!--<td style="font-size: 14px; padding-left: 5px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td>
						<td style="font-size: 14px; padding-left: 5px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td>-->
						<?php if($vdr_data['gst_no']!=''){?>
					...
					<tr>
					  	<td style="border-right: solid 1px #000333; border-top: solid 1px #000333; font-size: 14px; padding-left: 5px; font-weight: bold;">Wallet Deduction</td>
					  	<!-- <td style="font-size: 14px; padding-left: 5px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td> -->
						<!--<td style="font-size: 14px; padding-left: 5px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td>
						<td style="font-size: 14px; padding-left: 5px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td>-->
						<?php if($vdr_data['gst_no']!=''){?>
		...
		<tr>
			<td style="padding: 10px;">
				<table cellpadding="0" cellspacing="0" style="width: 100%; border-bottom: solid 1px #ddd; padding-bottom: 10px;">
					<tr>
						<td style="width: 80%; vertical-align: top; vertical-align: top;">
