 					 ...
 					 { ?>
						...
						<div class="item">
							...
							<a href="{{route('brandproducts',[base64_encode($value->id)])}}">
								<img  title="{{$value->name}}" src="{{ asset('/uploads/vendor/company_logo/'.$value->logo) }}"/>
							 </a>
							</div>
						</div>
					<?php }
         ...
         <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content"> 
                  ...
                  <div class="modal-header"> 
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><img src="{{ asset('public/fronted/images/remove-white.png') }}" alt=""> </button>
                  </div> 
							  ...
							  @if (!Auth::guard('customer')->check())
                                <div class="checkbox profile_form"> 
                                     <div class="form-group">
                                         <a href="#myModal" data-bs-target="#myModal" data-bs-toggle="modal" data-bs-dismiss="modal" type="button" class="btn"> Register</a>
                                    </div>
                               </div> 
							   @endif 
                          </div> 
