...
?>
<section class="add-section"><div class="container-fluid">
  <div class="featured-list">
  <div class="slide-heading"><h2>Featured Categories <span>Choose what you looking for</span></h2></div>
        <div class="owl-carousel owl-carousel-featured text-center"> <?php foreach($featured_cat as $cat){ $cat_name = preg_replace('/\s+/', '-',strtolower ($cat->name)); $url=route('cat_wise', [$cat_name,base64_encode($cat->id)]); ?> 
          <div class="item"><div class="add-image zoom1"><a href="{{$url}}"> <img src="{{URL::to('/uploads/category/logo')}}/{{$cat->logo}}" alt=""></a></div>
          <div class="text-box"><h4>{{$cat->name}}</h4></div>
        </div>
           <?php }?> </div>
        </div>
          </div>
...
<section class="add-section mt0sectn">
  <div class="container">
          @if($advertise_position7 || $advertise_position8)<div class="row">
            @if($advertise_position7)<div class="col-xs-12 col-sm-12">
        ...
        <div class="col-12 col-sm-6 col-md-5 col-lg-5">
            ...
            <div class="title">
                ...
                {!! $advertise_position1->description !!}
                    <a href="{{$advertise_position1->url}}" class="btn btn-warning btn-block btn-lg">Shop Now</a>
                </div>
            </div>
            </div>
        ...
        <div class="col-12 col-sm-6 col-md-5 col-lg-5">
            ...
            <div class="title">
                ...
                {!! $advertise_position3->description !!}
                    <a href="{{$advertise_position3->url}}" class="btn btn-warning btn-block btn-lg">Shop Now</a>
                </div>
            </div>
            </div>
            <div class="col-12 col-sm-6 col-md-7 col-lg-7">
        ...
        <div class="col-12 col-sm-6 col-md-5 col-lg-5">
            ...
            <div class="title">
                ...
                {!! $advertise_position4->description !!}
                    ...
                    <a href="{{$advertise_position4->url}}" class="btn btn-warning btn-block btn-lg">Shop Now</a>
                </div>
            </div>
            </div>
            <div class="col-12 col-sm-6 col-md-7 col-lg-7">
...
@if($advertise_position5)
<section class="add-section mt0sectn">
  <a href="{{$advertise_position5->url}}"><img src="{{ asset('uploads/advertise/'.$advertise_position5->image) }}" alt=""></a>
</section>
 @endif
        ...
        <div class="col-12 col-sm-6 col-md-5 col-lg-5">
            ...
            <h2>{{$advertise_position6->short_text}}</h2>
                ...
                {!! $advertise_position6->description !!}
                    <a href="{{$advertise_position6->url}}" class="btn btn-warning btn-block btn-lg">Shop Now</a>
                </div>
            </div>
            </div>
            <div class="col-12 col-sm-6 col-md-7 col-lg-7">
