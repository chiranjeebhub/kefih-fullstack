                ...
                <div class="row">
                 ...
                 <h3>Subscribe for Newsletter</h3>
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control get_email_data" value="" name="subscribe_email" placeholder="E-mail">
                          <button type="button" id="get_email_data" class="btn"><i class="fa fa-location-arrow"></i></button>
                      </div>
                ...
                <div class="row">
                   ...
                   <div class="fotr-media-item">
                    ...
                    <div class="fotr-media">
                     ...
                     <p><a href="mailto:{{$store_info->email}}"><i class="fa fa-envelope"></i> {{$store_info->email}}</a>  </p>
                    </div>
                </div>
                </div>
                    <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                   <div class="fotr-media-item">
                    ...
                    <div class="fotr-media">
                     ...
                     <a class="btn btn-warning btn-block btn-lg" href="#saleModalLabel" data-bs-toggle="modal">SELL WITH US</a>
                            --}}
                     <a class="btn btn-warning btn-block btn-lg" href="{{URL::to('seller/vendor_register/'.base64_encode(0))}}">SELL WITH US</a>
                           ...
                           <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <ul class="list-unstyled fotr-menu">
                                ...
                                @foreach( $vendrosactive as $row )
                                 <li><a href="{{route('brandproducts',base64_encode($row->id))}}">{{$row->name}}</a></li>
                                @endforeach
                            </ul>
                           </div>
                           <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                               <div class="fotr-media-item">
                                <h4>Policies</h4>
                                <ul class="list-unstyled fotr-menu">
                                    <li><a href="{{route('page_url',['privacy-policy'])}}">Privacy policy</a> </li>
                                    <li><a href="{{route('page_url',['terms'])}}"> Terms & Conditions </a> </li>
                                    <li><a href="{{route('page_url',['delivery_policy'])}}">Shipping policy </a> </li>
                                    <li><a href="{{route('page_url',['return_policy'])}}"  >Return & Refund Policy</a> </li>
                                    <li><a href="{{route('page_url',['cancellation-policy'])}}">Cancellation Policy</a> </li>
                   ...
                   <div class="fotr-media-item">
                    ...
                    <div class="list-inline hdr-social-link">
						<ul class="list-inline">
							<li><a href="{{$store_info->facebook_url}}"><i class="fa fa-facebook-square"></i> </a> </li>
							<li><a href="{{$store_info->instagram_url}}"><i class="fa fa-instagram"></i> </a> </li>
                            <li><a href="{{$store_info->linkedin_url}}"><i class="fa fa-linkedin"></i> </a> </li>
						</ul>
					</div>
                  </div>
         ...
         <div class="modal-dialog modal-sm">
                <div class="modal-content"> 
                  ...
                  <div class="modal-header"> 
                    ...
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close"><img src="images/remove.png" alt=""> </button>
                  </div>
        ...
        <div class="modal-body">
            <div class="form-box cardNewbox">
                <form class="main_section">
                    ...
                    <div class="mt-4"><a href="#" class="btn btn-warning btn-block btn-lg">Continue</a></div>
                </form>
            </div>
        </div>
      </div>
                         ...
                         <div class="popup_info profile_form">
                             <div class="form-group"> 
                                <select id="login_country_code" name="login_country_code"> 
                                    ...
                                    <option value="{{$row->phonecode}}">{{$row->sortname}} (+{{$row->phonecode}})</option>
                                    @endforeach                                 
                                </select>  
                            </div>
                         </div>
                      ...
                      <div class="col-lg-8 col-sm-8 col-md-8 col-12">
                        <div class="popup_info profile_form">
                             <div class="form-group"> 
                                ...
                                <input type="number" id="login_phone" min="0" inputmode="numeric" pattern="[0-9]*" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" name="phone" class="form-control" placeholder="000 000 0000" autocomplete="off">
                            </div>
                         </div>
                      </div>
                      <div class="col-lg-12 col-sm-12 col-md-12 col-12">
                            <div class="checkbox profile_form">
                                <div class="form-check-inline">
                                  <label class="form-check-label">
                                    ...
                                    <input type="checkbox" id="term_accepted" class="form-check-input" name="term_accepted" value="1" required>By continuing, I agree to the <a href="{{route('page_url',['terms'])}}">Terms of Use & Privacy Policy</a> </label>
                                </div>
                                 <div class="form-group">
                      ...
                      <div class="col-lg-12 col-sm-12 col-md-12 col-12">
                       ...
                       <div class="col-lg-12 col-sm-12 col-md-12 col-12">
                          <div class="other_login"> 
                              <a href="#"><img  src="{{ asset('public/fronted/images/facebook.png') }}" alt=""></a>
                                <a href="#"> <img  src="{{ asset('public/fronted/images/google.png') }}" alt=""></a>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
              ...
              <div class="modal-header">
                ...
                <button type="button" class="close" data-dismiss="modal"><img src="{{ asset('public/fronted/images/remove-white.png') }}" alt=""> </button>
              </div>
                  ...
                  <div class="row">
                     <div class="col-lg-12 col-sm-12 col-md-12 col-12">
                         ...
                         <p id="otp_response"></p>
                             ...
                             <h2><span id="otp_phone_no"></span><a href="javascript:void(0);" id="changeOTP_phone">Change</a> </h2>
                         </div>
                      </div>
                      <div class="col-lg-12 col-sm-12 col-md-12 col-12">
                        <div class="popup_info profile_form">
                             <div class="form-group"> 
                                 <input type="text" id="login_otp_1"  min="0" inputmode="numeric" pattern="[0-9]*" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control login_otp_fld" placeholder="">
                                 <input type="text" id="login_otp_2" min="0" inputmode="numeric" pattern="[0-9]*" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control login_otp_fld" placeholder="">
                                 <input type="text" id="login_otp_3" min="0" inputmode="numeric" pattern="[0-9]*" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control login_otp_fld" placeholder="">
                                 <input type="text" id="login_otp_4" min="0" inputmode="numeric" pattern="[0-9]*" maxlength="1" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control login_otp_fld" placeholder="">
                      ...
                      <div class="col-lg-12 col-sm-12 col-md-12 col-12">
                            <div class="checkbox profile_form"> 
                                 <div class="form-group">
                                     ...
                                     <a href="javascript:void(0);" id="verifyOTPbtn" class="btn btn-warning btn-lg btn-block"> Continue</a>
                                </div>
                           </div> 
                      </div> 
                  </div>
...
<div class="fixoffer-rgtbar">
    <div class="Summer-banner">
        ...
        <a class="btn btn-outline-light" href="#myModal" data-bs-toggle="modal" data-bs-dismiss="modal"> Register</a>
        @endif 
    </div>
</div>
@endif 
