        ...
        <div class="collapse navbar-collapse leftMenu" id="navbarNavDropdown">
          <ul class="navbar-nav menuwithmegam">
              ...
              <li class="nav-item dropdown position-static">
                ...
                @endif 
              <li class="nav-item dropdown position-static">
                <a class="nav-link dropdown-toggle {{$isbrandActive}}" href="{{route('branddetails')}}" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Brands</a>
                    <div class="dropdown-menu p-4" aria-labelledby="dropdown04">
