	...
	<div class="row">     	
		<div class="col-md-12 col-xs-12">   
			<table cellpadding="0" cellspacing="0" style="width:100%; font-family: 'Be Vietnam', sans-serif; padding:0px; background: #fff; ">    
					...
					<td class="sellerInvc" style="text-align: left; background: #fff">
						...
						<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #737373; font-size: 12px;">
							<tr bgcolor="#ebecec">
								...
								<th style="border-right: solid 1px #737373; font-size: 10px;">Tax Rate(%)</th>
								<?php if($tax_column==1){?>
								<th style="border-right: solid 1px #737373; font-size: 10px;">IGST(Rs.)</th>
								<?php } if($tax_column==2){?>
								<th style="border-right: solid 1px #737373; font-size: 10px;">CGST(Rs.)</th>
								<th style="border-right: solid 1px #737373; font-size: 10px;">SGST(Rs.)</th>
								<?php } ?>
				...
				<tr>
					<td style="padding: 5px 15px;">
						<p style="font-size: 12px; margin-top: 5px; font-style: italic; line-height: 16px;"><strong style="font-style: normal;">Return Policy</strong> : At kefih.com we try to deliver perfectly each and every time. But in the off-chance that you need to return the item, please do so with the original Brand box/price tag, original packing and invoice without which it will be really difficult for us to act on your request. Please help us in helping you. Terms and conditions apply. The goods sold as are intended for end user consumption and not for re-sale.<br/></p>
					</td>	
				</tr>                
			</table>
		</div>
