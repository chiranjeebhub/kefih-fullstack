  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="item-ordered order_list order_details">
            <h6 class="fs18 fw600 mb20">Return & Refund Order</h6>
          @if ($errors->any())
          ...
          <form role="form" class="form-element" action="{{ route('return_refund_order',base64_encode($master_id)) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="db-2-main-com db-2-main-com-table packagetbl">
                  ...
                  <div class="table_row">
                    <div class="table_small">
                      ...
                      <div class="table_cell"><a href="{{App\Products::getProductDetailUrl($order->product_name,$order->product_id)}}" class="">
                          ...
                          <?php
                          $productData = App\Products::where('id',$order->product_id)->first(); 
                        
                          $productSKU = $productData->sku;
                          
                          $imagespathfolder='uploads/products/'.$productData->vendor_id.'/'.$productSKU;
                          $imageURL = '';
                          if ($order->color_id != 0) {
                            $productskuid=DB::table('product_attributes')->where(['product_id'=>$order->product_id,'color_id'=>$order->color_id])->first();

                            $colorwise_images = DB::table('product_configuration_images')
                              ->where('product_id', $order->product_id)
                              ->where('color_id', $order->color_id)
                              ->first();
                              $productSKU = $productskuid->sku; 
                              $imagespathfolder='uploads/products/'.$productData->vendor_id.'/'.$productSKU;
                            ...
                            $imageURL = URL::to($imagespathfolder).'/'.$colorwise_images->product_config_image;
                          } else {
                            $productimages=DB::table('product_images')->where('product_id',$order->product_id)->first();
                            // $url = URL::to('/uploads/products') . '/' . $order->default_image;
                            $imageURL = URL::to($imagespathfolder).'/'.$productimages->image;
                          }
                    ...
                    <div class="table_small">
                      ...
                      <div class="table_cell">
                        ...
                        ?>
                          ...
                          <input class="form-check-input cancel_reutrn_radio_button" type="radio" checked call_method="1" style="display: block !important;" name="order_id[]" value="{{$order->id}}" prd_id="{{$order->product_id}}">
                          </div>
              ...
              <div class="row">
                <label class="return-policy-text"><a class="text-warning" href="{{route('page_url',['return_policy'])}}" target="_blank">Return policy</a></label>
                ...
                <div class="row mt-2">
                  <div class="form-group switch_box">
                    ...
                    <div class="form-check form-switch">
                      ...
                      <input id="terms1" type="checkbox" class="form-check-input" checked name="condition_accepted">
                      <label for="terms1" class="form-check-label"> Terms &amp; Conditions</label>
                    </div>
                  </div>
                </div>
                <div class="row mt-4 profile_form">
                  ...
                  <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <select name="return_or_refund" class="form-control custom-select returnType" suborder_id="{{$order->id}}" product_id="{{$order->product_id}}">
                  ...
                  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 refundState">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <input type="text" name="account_holder_name" value="" class="form-control" placeholder="Enter Account Holder Name">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 refundState">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <input type="text" name="account_no" value="" class="form-control" placeholder="Enter Account No.">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 refundState">
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        <input type="text" name="ifsc_code" value="" class="form-control" placeholder="Enter IFSC CODE">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3 refundState">
                    <div class="form-group">
                      <label>Branch </label>
                      <div class="form-group">
                        <input type="text" name="branch" value="" class="form-control" placeholder="Enter Branch">
                      </div>
                    </div>
                  </div>
