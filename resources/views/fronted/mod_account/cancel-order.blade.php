...
<div class="row">
                <div class="col-md-12">
					...
					<div class="item-ordered order_list order_details">
                        <h6 class="fs18 fw600 mb20">Cancel Order</h6>
 @if ($errors->any())
								  ...
								  <div class="table_cell">
								   ...
								   @switch($order->order_status)
                                      ...
                                      <div class="form-check">
                                        <input type="radio" checked class="cancel_reutrn_radio_button radio-menu form-check-input" style="display:block !important" call_method="0" name="order_id[]" value="{{$order->id}}" prd_id={{$order->product_id}}>
                                    </div>
                                        ...
                                        @case(1)
                                      <div class="form-check">
    <input  type="radio" checked class="cancel_reutrn_radio_button radio-menu form-check-input" 
				...
				<div class="row mt20">
					<div class="form-group switch_box">
						 ...
						 <div class="form-check form-switch">
							...
							<label class="form-check-label" for="terms1"> Terms &amp; Conditions</label> 
						 </div>
					</div>
				</div>
				<div class="row mt-4">
					
          <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 profile_form">
           ...
           <div class="form-group">
            <select name="reason" class="form-control custom-select cancel_reason" id="country">
              ...
              <button class="btn btn-warning btn-lg" type="submit" value="submit">Submit</button>     
              </div>
               </div>   
          </div>
