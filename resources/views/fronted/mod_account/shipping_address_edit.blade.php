    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-sm-12 col-md-12 col-12 pt-4 pb-4">
                <h2 class="heading mb-30">Update Delivery Address</h2>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group switch_box">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="default_address" name="shipping_address_default" 
            <?php echo ($shipping_data->shipping_address_default==1)?'checked':'';?> /><label class="form-check-label" for="default_address"> Make Default Address</label>
                                    </div>
                                </div>
