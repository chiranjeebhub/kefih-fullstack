...
if($prd_detail['product_type']=='1')
{
    ...
    $productskuid=DB::table('product_attributes')->where('product_id',$prd_detail['id'])->first();
    ...
    <div class="container">
        <div class="row">					
                        ...
                        <div class="detail-gallery">
                            <div class="thumb-product mid">											
                                ...
                                <div id="facnyBoxitem">
                                    ...
                                    if($flag==2){?>
                                    <a class="<?php echo ($ij>0)?"dnoneD":"fancyZoom";?>" data-fancybox="gallery" href="{{URL::to($imagespathfolder)}}/{{$row['image']}}">

                                        <img id="img_zoom" src="{{URL::to($imagespathfolder)}}/{{$row['image']}}" data-zoom-image="{{URL::to($imagespathfolder)}}/{{$row['image']}}" alt="" class="imgs" />
                            ...
                            <div class="gallery-control nonCircular">
                                <div class="carousel thumblist" data-vertical="true">
                                    <ul class="list-none" id="leftthumbslidercontainer">
                                        ...
                                        @foreach($prd_slider as $row)											
                                        <?php if($flag==2){?>													
                                        <li><a href="javascript:void(0)"   data-image="{{URL::to( $imagespathfolder)}}/{{$row['image']}}" data-zoom-image="{{URL::to($imagespathfolder)}}/{{$row['image']}}" class="active"> <img  src="{{URL::to($imagespathfolder)}}/{{$row['image']}}" class="customThumnnail" data-large-image="{{URL::to($imagespathfolder)}}/{{$row['image']}}"/></a></li>													
                                        <?php } if($flag==1){
            ...
            <div class="col-sm-12 col-md-7 col-lg-7 details">
                ...
                <h3 class="product-title"><a href="{{route('brandproducts',base64_encode($prd_detail->vendor_id))}}">{{$prd_detail->companyName}}</a></h3>
                @endif 
                ...
                <div class="prdtdtailprice">
                    <h4 class="price">
                            ...
                            <span class="off">(<span class="percent">{{$prd_detail::offerPercentage($prd_detail->price+$extrs_price,$prd_detail->spcl_price+$extrs_price)}}</span>  % off)</span>
                            @else
                            <i class="fa fa-rupee"></i> <span id="prd_price_0">{{$prd_detail->spcl_price+$extrs_price}}</span>
                            @endif
                    </h4>
                ...
                <ul class="list-inline detail-taxes">
                    <li>You will save <i class="fa fa-rupee"></i> <span id="saveamt{{$prd_detail->id}}">{{($saveAmount>0)?$saveAmount:0}}</span></li>
                    ...
                    <div class="col-4 col-sm-4 col-md-4" style="display:none;">
                      <div class="qty-btn">
                       ...
                       <!-- class changeQty for plus and minus button -->
                            <button class="sign sub  " method="2" row="0"><i class="fa fa-minus"></i></button><input type="number" id="prd_qty_0" name="qty" min="{{$prd_detail->moq}}" value="1" title="Qty" class="qty-input qty text" size="{{$prd_detail->moq}}" disabled >
                            <button id="add" class="sign add " method="1" row="0"><i class="fa fa-plus"></i></button>
                        </div>
                        </div>
                      </div>
                </div>
                ...
                <div class="detail-cartbtns">
                  <div class="row">
                        ...
                        <div class="col-md-12 col-xs-12">
                            ...
                            <div class="row">
                              <div class="col-6 col-sm-6 col-md-6 pding-lft0">
                                  @if($prd_detail->product_type==2)
                                    <button type="submit"
                                    class="btn blackbtn btn-block waddTocart noProblem"
                                    prd_page='1'
                                    prd_index='0' 
                                    ...
                                    <button type="submit"
                                    class="btn blackbtn btn-block addTocart noProblem"
                                    prd_page='1'
                                    prd_index='0' 
                                    prd_id='{{$prd_detail->id}}'
                                    size_require="{!!$prd_detail::Issize_requires($prd_detail->id)!!}"
                              ...
                              <div class="col-6 col-sm-6 col-md-6 pding-lft0">
                                  @if($prd_detail->product_type==2)
                                     <button type="submit" 
                                     class="btn btn-warning btn-block buyNow noProblem"
                                    prd_page='1'
                            ...
                            <div class="col-6 col-sm-6 col-md-6 pding-lft0">
                                <button type="submit" class="btn btn-danger btn-block add-to-cart-btn add-to-cart btn btn-warning ml30 outOfStcok mb-2">
<i class="fa fa-shopping-cart"></i>  Out of stock
                            ...
                            <div class="col-6 col-sm-6 col-md-6 pding-lft0">
                                <button type="submit" class="btn btn-danger btn-block add-to-cart-btn add-to-cart ml30 outOFdelivery">
                                NO delivery
                                </button>    
                            </div>
                            <div class="col-6 col-sm-6 col-md-6 pding-lft0">
                                <button type="submit" class="btn btn-danger btn-block add-to-cart-btn bynow outOFdelivery">
                                NO delivery
                                </button>    
                            </div>
                        </div>
...
<div class="dec-nav-tab">
    ...
    <ul class="nav nav-pills" id="pills-tab" role="tablist">
      <li class="nav-item" role="presentation">
        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-Additionalinfo" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Description</button>
      </li>
       <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-Additional" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Additional Information</button>
      </li>
               <li class="nav-item" role="presentation">
        <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-Ratings" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Reviews</button>
      </li>
						...
						<div class="tab-content" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-Additionalinfo" role="tabpanel" aria-labelledby="pills-home-tab">
							...
							<div class="tab-pane fade" id="pills-Additional" role="tabpanel" aria-labelledby="pills-home-tab">
                                <div class="details-dec">
                            ...
                            <div class="tab-pane fade" id="pills-Ratings" role="tabpanel" aria-labelledby="pills-home-tab">
											...
											<div class="post-review">
												<h6 class="fw600 fs20">Add your Comments:</h6>
													...
													<div class="col-md-12 mt10 text-center">
                                                        <div class="btn-width">
														<button type="submit" class="btn btn-warning btn-block" value="submit">Submit</button>
                                                        </div>
													</div>
												</div>
														</form>
