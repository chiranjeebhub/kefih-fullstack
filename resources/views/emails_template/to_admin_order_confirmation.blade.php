                ...
                <table cellpadding="0" cellspacing="0" style="padding: 15px; background: #fff; width:100%; margin: -5px auto;">
                    <tr bgcolor="#fffff">
						<td style="text-align: center; padding: 5px 0;">
							...
							<a href="{{url('/')}}"><img width="200px;" alt="Kefih" src="{{ asset('public/fronted/images/logo.png') }}"></a>
						</td>
					</tr>
                        ...
                        <td>
                            <table cellpadding="0" cellspacing="0" style="width: 100%;">
								...
								<div><p style="text-align:center; "><img width="120px" src="{{ asset('public/fronted/images/confirmed-icon.png') }}"></p>
                                            ...
                                            <tr>
												<td>
													<p style="margin: 10px 0;">Hi,</p>
													<p style="margin: 10px 0;">We have a new order from customer  {{ucfirst($customer_info->name)}}.</p>
		   ...
		   $url=URL::to('/uploads/products').'/'.$products->default_image; 
			 ...
			 <?php if(@$extra_info->deduct_reward_points!=''){ ?>
				...
				<span style="color: #1aa4bb;">Rs. {{@$extra_info->deduct_reward_points}}</span>
					...
					<tr>
						<td><p style="font-size:18px; line-height:24px;">E-mail us: <a style="color:#000;" href="mailto:contact@kefih.com">contact@kefih.com</a></p>
...
margin-left: 10px;">
							...
							<a href="https://www.snapchat.com/add/" target="_blank"><img title="Snapchat" width="30px;" src="{{ asset('public/fronted/images/snapchat-icon.png') }}"></a> 
							<a href="https://www.facebook.com//" target="_blank"><img title="Facebook" width="30px;" src="{{ asset('public/fronted/images/facebook-icon.png') }}"></a> 
