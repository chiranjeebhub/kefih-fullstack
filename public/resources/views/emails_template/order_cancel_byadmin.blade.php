            ...
            <td>
                                        ...
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; font-size:17px; padding: 20px;">
											...
											<tr>
												<td>
													...
													<p style="margin: 10px 0;">We have cancelled your order. For more info contact to our support anupsharma6580@gmail.com</p>
													<p style="margin: 15px 0 0;">Thank you,</p>
													<p style="margin: 10px 0 40px;"><strong>Redlips</strong>.Com</p>
												</td>
											</tr>
                                            <tr>
													...
													<table cellpadding="0" cellspacing="0" style="width: 100%; border: solid 1px #e6e6e6;">
														<tr bgcolor="#fff">
															<td>
																<table cellpadding="0" cellspacing="0" style="width: 100%;">
																	<tr>
																		<td><img style="float: left;" width="150px;" src="https://www.redlips.com/uploads/products/240-180/<?php echo $data['product_details']['product_image']; ?>" />
																		</td>
                ...
                <tr>
                    <td>
                        ...
                        margin-left: 10px;">
                        <a href="#" target="_blank"><img title="Twitter" width="30px;" src="https://www.redlips.com/public/fronted/images/twitter-icon.png"></a> 
                        <a href="#" target="_blank"><img title="Snapchat" width="30px;" src="https://www.redlips.com/public/fronted/images/snapchat-icon.png"></a> 
                        <a href="#" target="_blank"><img title="Facebook" width="30px;" src="https://www.redlips.com/public/fronted/images/facebook-icon.png"></a> 
                        <a href="#" target="_blank"><img title="Instagram" width="30px;" src="https://www.redlips.com/public/fronted/images/instagram-icon.png"></a></span></p>
                    </td>
                </tr>
					</tr>
