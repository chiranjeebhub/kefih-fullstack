				...
				<tr bgcolor="#231f20">
                    <td>
                        <ul style="display:inline-block; width:100%; ">
                            <!--<li align="left" style="color: #d01f27; font-size: 18px; float: left; margin-right:38px;"><a style="font-size: 20px; color: #fff; text-decoration: none;" href="#" target="_blank">REFER AND EARN</a></li>-->
                            <li align="left" style="color: #d01f27; font-size: 18px; float: left;  margin-right:38px;"><a style="font-size: 20px; color: #fff; text-decoration: none;" href="#" target="_blank">ABOUT US</a></li>
                            <li align="left" style="color: #d01f27; font-size: 18px; float: left; "><a style="font-size: 20px; color: #fff; text-decoration: none;" href="#" target="_blank">TERMS & CONDITIONS</a></li>							
                        </ul>							
                    </td>
                </tr>
                <tr>
                    <td>
                        <p style="font-size:18px; line-height:24px;">  <br/>E-mail us: <a style="color:#000;" href="mailto:anupsharma6580@gmail.com">anupsharma6580@gmail.com</a></p>
                        ...
                        margin-left: 10px;">
                        <a href="#" target="_blank"><img title="Twitter" width="30px;" src="https://www.redliips.com/public/fronted/images/twitter-icon.png"></a> 
                        <a href="#" target="_blank"><img title="Snapchat" width="30px;" src="https://www.redliips.com/public/fronted/images/snapchat-icon.png"></a> 
                        <a href="#" target="_blank"><img title="Facebook" width="30px;" src="https://www.redliips.com/public/fronted/images/facebook-icon.png"></a> 
                        <a href="#" target="_blank"><img title="Instagram" width="30px;" src="https://www.redliips.com/public/fronted/images/instagram-icon.png"></a></span></p>
                    </td>
                </tr>
					</tr>
