					...
					<tr bgcolor="#231f20">
						<td>
							<ul style="display:inline-block; width:100%; ">
								...
								<li align="left" style="color: #ee1d23; font-size: 18px; float: left; "><a style="font-size: 20px; color: #fff; text-decoration: none;" href="{{route('page_url',['terms'])}}" target="_blank">TERMS & CONDITIONS</a></li>							
							</ul>							
						</td>
					</tr>
					<tr>
