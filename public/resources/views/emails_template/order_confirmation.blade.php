...
$url=URL::to('/uploads/products/240-180').'/'.$colorwise_images->product_config_image;
  ...
  $url="https://redliips.com/uploads/products/".$prd_info->default_image;                
			 ...
			 <?php if(@$extra_info->deduct_reward_points!=''){ ?>
					<p style="margin: 0 0 10px; font-size:16px; color:#6a6969;">Redlips coins<span style="text-align: right; float: right;"> 
				...
				<span style="color: #1aa4bb;">Rs. {{@$extra_info->deduct_reward_points}}</span>
					...
					<tr>
						<td>
						    <p style="font-size:18px; line-height:24px;">E-mail us: <a style="color:#000;" href="mailto:anupsharma6580@gmail.com">anupsharma6580@gmail.com</a></p>
						    <p style="font-size:18px; line-height:24px;">Customer Care: <a style="color:#000;" href="#">+91-7272020268</a></p>
...
margin-left: 10px;">
                            ...
                            <a href="https://www.instagram.com/Redlipsofficial/?hl=en" target="_blank"><img title="Instagram" width="30px;" src="{{ asset('public/fronted/images/instagram-icon.png') }}"></a>
                            </span></p>
						</td>
					</tr>
