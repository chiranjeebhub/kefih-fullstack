	   	...
	   	<table cellpadding="0" cellspacing="0" style="width:100%; font-family:Arial, Helvetica, sans-serif; font-size:13px; font-weight:normal; line-height:18px;">
            ...
            <tr>
                <td colspan="2" style="padding:10px;">
                    <p>Thank you <br />Warm Regards</p> <p>Team <br /><strong>Jaldi Kharido</strong></p>
                    <p style="font-size:18px; line-height:24px;">Customer Care: <a style="color:#000;" href="#">+91 80058 53043</a></p>
                    <p style="text-transform:uppercase;">This is a self Generated Mail. Please Do Not Reply To it </p>
                </td>
            </tr>
        </table> 
    </div>
