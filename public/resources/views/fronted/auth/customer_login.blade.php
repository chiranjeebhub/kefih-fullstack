...
<div class="registrform loginpage form-box-width">
...
<!--<p>or use your phone for login</p>-->
   ...
   <form role="form" class="form-element" action="{{ $page_details['Action_route']}}" method="post" enctype="multipart/form-data">
    ...
    <input type="text" class="form-control" id="email" name="phone"  placeholder="Enter Email Id " value="">
    ...
    <div class="form-group">
        <!--<a id="otpclick" href="{{ route('OTP_login')}}" style="text-align:left; float:left;">Login with OTP </a> --><a style="text-align:right; float:right;" href="{{ route('forgot_password')}}">Forgot Password?</a>
    </div>
    
    <a href="{{ route('login')}}"><button type="submit" class="registrbtn"> Login</button></a> 
