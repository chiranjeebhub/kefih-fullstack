		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
				<div class="dashbordtxt">
					<h6 class="fs18 fw600 mb20">Order Id - {{@$master_order->order_no}}</h6> 
                                  ...
                                  @if ($order->color_id!=0)
                                    ...
                                    @endif
                                       ...
                                       if($today<$return_date){
                                          ?>
								        <a href="{{ route('return_refund_order',base64_encode($order->id)) }}" class="orderbtn orderbtn-bgblack"><i class="fa fa-undo" title="Return"></i> Return</a>
												<?php } else{?>
                                          <span>Return Days Expires</span>
                                          <br>
 <a class="orderbtn orderbtn-bgblack" href="{{App\Products::getProductDetailUrl($order->product_name,$order->product_id,$order->size_id,$order->color_id)}}" title=""><i class="fa fa-star"></i> Rate This</a>
                                    <?php }?>
                                       ...
                                       if($today<$return_date){
                                          ?>
												...
												<i class="fa fa-undo" title="Return"></i> Return</a>
                                                    <?php } else{?>
                                          <span>Return Days Expires</span>
                                          <br>
<a class="orderbtn orderbtn-bgblack" href="{{App\Products::getProductDetailUrl($order->product_name,$order->product_id,$order->size_id,$order->color_id)}}"><i class="fa fa-star"></i> Rate This </a>
                                    <?php }?>
