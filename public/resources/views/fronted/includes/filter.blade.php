...
<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 sidebar__inner mr-btm-40">
    <div class="filter-leftbar">
    <div class="filter">
        <h6>Filter by  <span id="account-btn"><i class="fa fa-navicon"></i></span>
		<div class="clearall">         
			<a href="javascript:void(0)" id="clear_all" style="display:<?php echo ($type_filter!='')?'block':'none'; ?>; color:black;">Clear all</a>                   
		</div> 
		</h6>

		<h6 class="col-xs-4 hidden-xs hidden-sm hidden-md hidden-lg"> <span id="sortt-btn"> <i class="fa fa-navicon"></i></span>  
		<!-- <div class="clearall">         
