		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
			    ...
			    <div class="dashbordtxt">
					<h6 class="fs18 fw600 mb20">My Referrals (Total earned <i class="fa fa-inr"></i> {{auth()->guard('customer')->user()->r_amount}}),
					    <span class="badge badge-danger refferalcodeBox">
                            Your referral code: {{auth()->guard('customer')->user()->r_code}} <a href="javascript:void(0)" data-page_id="{{auth()->guard('customer')->user()->r_code}}" id="myItem">Copy</a>

                        </span>
                        
                        <div class="shareboxdash"> <span>Share Via :</span>
                            <a target="_blank" href="https://web.whatsapp.com/send?phone={{auth()->guard('customer')->user()->phone}}&text={{@$code}}"><i class="fa fa-whatsapp"></i></a> 
                         <a href="https://mail.google.com/mail/?view=cm&fs=1&tf=1&su={{@$code}}&body=<?php echo auth()->guard('customer')->user()->email; ?>" target="_BLANK"><i class="fa fa-envelope-o"></i></a>
                                                </div>
