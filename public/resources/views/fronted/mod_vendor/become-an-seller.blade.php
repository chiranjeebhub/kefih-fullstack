...
@endsection
<section class="seller-section" style="background: {{ asset('public/fronted/images/become-an-seller-banne.jpg') }}; background-repeat: no-repeat;">
<div class="container">
<div class="row">
<div class="col-md-12">
<div class="seller-register">
<div class="register-heading"><h6 class="fw600 fs20 text-blue">Log in</h6>  </div>  
   <form class="pd30" action="">
    <div class="form-group">
    <input type="email" class="form-control" id="email" placeholder="Emai Id">
    </div>
    ...
    <a class="text-white mt10" href="seller-account.html" target="_blank"><i class="fa fa-lock"></i> Create your Seller Account</a>   
    </form>    
</div>    
</div>    
</div>    
...
<section class="seller-section1" style="background:{{ asset('public/fronted/images/seller-background.jpg') }};background-repeat: no-repeat;
background-size: cover; background-attachment: fixed;">
    ...
    <div class="col-md-6">
   <div class="why18up">
     <h6 class="fs40 fw700 mb20 text-white">Why 18UP</h6> 
...
<section class="testimonial-section">
		<div class="large-container">
			<div class="sec-title">
				<h6 class="title fs25 fw600 ">Doing business on 18UP is really easy</h6>
