...
<nav class="mt15">
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
	...
	<a class="nav-item nav-link  <?php echo ($parameters_level==0)?'active':''; ?>"  href="{{ route('offer_slider',base64_encode(0)) }}">Featured Products </a>
	<!-- <a class="nav-item nav-link <?php echo ($parameters_level==5)?'active':''; ?>"  href="{{ route('offer_slider',base64_encode(5)) }}">Offer Going on</a> -->
			<a class="nav-item nav-link <?php echo ($parameters_level==1)?'active':''; ?>"  href="{{ route('offer_slider',base64_encode(1)) }}">New Launches</a>
