        ...
        <tr bgcolor="#ebecec">
			<td style="vertical-align: top; padding: 30px;">
				<table cellpadding="0" cellspacing="0" style="width: 100%;">
					...
					<tr bgcolor="#ebecec">
						<td>Invoice number : 000000000000</td>
						<td style="text-align: right;">phaukat.in Order id : 0000000000000</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td style="padding: 30px; text-align: left; background: #fff">
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #737373; font-size: 14px;">
					...
					<tr>
						<td style="border-right: solid 1px #737373; padding-left: 20px;">Seller name : </td>
					  	<td style=" padding-left: 20px;">Invoice Date : 000000000000</td>
					</tr>
					<tr>
					  	<td style="border-right: solid 1px #737373; padding-left: 20px;">Address : </td>
					  	<td style=" padding-left: 20px;">Order Date : 000000000000</td>
					</tr>
					<tr>
				...
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #737373; border-top:none; font-size: 14px;">
					...
					<tr>
						<td style="border-right: solid 1px #737373; padding-left: 20px;">Buyer Name : </td>
					...
					<tr>
					  	<td style="border-right: solid 1px #737373; padding-left: 20px;">Ph. : </td>
				...
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #737373; font-size: 14px;">
					...
					<tr>
						<td style="border-right: solid 1px #737373; padding-left: 20px;">Item name</td>
					...
					<tr>
					  	<td style="border-right: solid 1px #737373; padding-left: 20px;">HSN Code</td>
					  	<td style=" padding-left: 20px; border-right: solid 1px #737373;">&nbsp;</td>
						<td style=" padding-left: 20px; border-right: solid 1px #737373;">&nbsp;</td>
						<td style=" padding-left: 20px; border-right: solid 1px #737373;">&nbsp;</td>
						<td style=" padding-left: 20px; border-right: solid 1px #737373;">&nbsp;</td>
...
<span style="font-size: 12px; font-weight: normal;">For Shopping With Us</span></td>
		...
		<tr>
			<td style="padding: 20px 30px;">
				<p style="font-size: 13px; margin-top: 5px; font-style: italic; line-height: 24px;"><strong style="font-style: normal;">Returns Policy</strong> : At phaukat.in we try to deliver perfectly each and every time. But in the off-chance that you need to return the item, please do so with the original Brand box/price tag, original packing and invoice without which it will be really difficult for us to act on your request. Please help us in helping you. Terms and conditions apply.<br/>
