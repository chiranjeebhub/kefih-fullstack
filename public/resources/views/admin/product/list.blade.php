				 ...
				 <?php #<input type="hidden" value="43" id="ProductVendor"> ?>
					<div class="row searchmain-row">
					    ...
					    <div class="col-sm-8 col-md-2">
					        <select class="form-control fdProductVendor" id="ProductVendor">
...
>{{$Brand->name}}</option>
        ...
        {!! App\Helpers\CustomFormHelper::form_builder($page_details['Form_data']['Form_field']['select_field']); !!}
					...
					<div class="col-sm-9  col-md-4">
						<div class="searchmain productLst">
<input type="text" class="form-control ProductSearchString" placeholder="Search" id="searchBox" value="<?php echo ($parameters!='All')?$parameters:"";?>">
     ...
     <div class="modal-body">
        ...
        @csrf
            <div class="row">
                ...
                <div class="col-md-6">
                    <select name="product_type" class="form-control">
                    <option value="0">Featured Products</option>
