        ...
        <div style=" margin-top: 20px; margin-bottom: 30px;clear:both;">
                ...
                <div class="maindiv" style="padding: 0x; background: #fff; ">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tr><td><h2>Supplier Details</h2></td><td style="width: 100px;">&nbsp;</td><td colspan="3"><h2 style="font-weight: 700;">Settlement Voucher</h2></td><td><h2>{{$Order[0]['tcs_invoice_no']}}</h2></td></tr>
                        <tr>
