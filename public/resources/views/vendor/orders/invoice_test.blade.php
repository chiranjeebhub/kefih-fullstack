			...
			<td style="vertical-align: top; padding: 30px;">
				<table cellpadding="0" cellspacing="0" style="width: 100%;">
					...
					<tr bgcolor="#ebecec">
						...
						<td style="text-align: right;">Jaldi Kharido Order Id : {{ucwords($Order[0]['order_no'])}}</td>
					</tr>
				</table>
			</td>
			...
			<td style="padding: 30px; text-align: left; background: #fff">
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #737373; font-size: 14px;">
					...
					<tr>
						...
						<br>Payment Mode: <?php echo ($Order[0]['payment_mode']==1)?'Prepaid':'COD';?>
						</td>
					</tr>
					<tr>
				...
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #000333; font-size: 14px;">
					...
					<tr>
						...
						<?php }?>
						<?php }?>
						<td style="">{{number_format($row['product_price'],2)}}</td>
					</tr>
					<tr>
					  	<td style="border-right: solid 1px #000333; padding-left: 20px;">
					...
					<tr>
						...
						<?php }?>
						<td style="font-size: 14px; padding-left: 20px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td> 
						<td style="font-size: 14px; border-top: solid 1px #000333;">{{number_format(round(($total+$ship_total+$cod_total-$wallet_total-$coupon_total+$slot_price)),2)}}</td>
					</tr>
				</table>
			</td>	
		</tr>
...
<span style="font-size: 12px; font-weight: normal;">For Shopping With Us</span></td>
		...
		<tr>
			<td style="padding: 20px 30px;">
				<p style="font-size: 13px; margin-top: 5px; font-style: italic; line-height: 24px;"><strong style="font-style: normal;">Return Policy</strong> : At jaldikharido.com we try to deliver perfectly each and every time. But in the off-chance that you need to return the item, please do so with the original Brand box/price tag, original packing and invoice without which it will be really difficult for us to act on your request. Please help us in helping you. Terms and conditions apply.<br/>
The goods sold as are intended for end user consumption and not for re-sale.<br/>
Contact jaldikharido.com : help@jaldikharido.com <br>Customer Care: +91-8888888888</p>
			</td>	
		</tr>
