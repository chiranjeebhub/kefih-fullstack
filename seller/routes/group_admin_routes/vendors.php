...
Route::get('/vdr_term_sts/{id}/{sts}', 'sws_Admin\AdminController@vdr_term_sts')->name('vdr_term_sts');
...
Route::get('/vendor_rating/{v_id}', 'sws_Admin\AdminController@vendor_rating')->name('vendor_rating');
Route::get('/vdr_rt__sts/{id}/{sts}', 'sws_Admin\AdminController@vdr_rt__sts')->name('vdr_rt__sts');
...
Route::get('/delete_bank/{id}', 'sws_Admin\VendorController@deleteBankDetails')->name('delete_bank');
...
Route::any('/contact-us', 'sws_Admin\CommonController@contactusEnquiry')->name('contact-us');
