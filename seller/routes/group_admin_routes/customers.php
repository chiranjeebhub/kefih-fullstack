...
Route::get('/customers_search/{name}/{status}/{phonestatus}/{row}', 'sws_Admin\CommonController@customers')->name('customers_search');
Route::get('/customers_pay', 'sws_Admin\CommonController@customers_payment')->name('customers_pay');
Route::get('/customers_pay_search/{daterange}', 'sws_Admin\CommonController@customers_payment')->name('customers_pay_search');
Route::get('/customers_export', 'sws_Admin\CommonController@customers_export')->name('customers_export');
Route::get('/customers_pay_export_dt/{daterange}', 'sws_Admin\CommonController@customers_pay_export')->name('customers_pay_export_dt');
Route::get('/customers_pay_export', 'sws_Admin\CommonController@customers_pay_export')->name('customers_pay_export');
