...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/materirals', 'sws_Admin\AttributeController@materiralsm')->name('materirals');
...
Route::any('/color_export', 'sws_Admin\AttributeController@color_export')->name('color_export');
Route::any('/color_search_export/{str}/{status}', 'sws_Admin\AttributeController@color_export')->name('color_export');
Route::any('/color_search_export_str/{str}', 'sws_Admin\AttributeController@color_export')->name('color_export');

Route::any('/size_export', 'sws_Admin\AttributeController@size_export')->name('size_export');
Route::any('/size_search_export/{str}/{status}', 'sws_Admin\AttributeController@size_export')->name('size_search_export');
Route::any('/size_search_export_str/{str}', 'sws_Admin\AttributeController@size_export')->name('size_search_export_str');
