...
Route::get('/v_enquiry', 'sws_Admin\ProductController@enquirry_vendor')->name('v_enquiry');
Route::get('/delete_v_enquiry/{id}', 'sws_Admin\ProductController@delete_v_enquiry')->name('delete_v_enquiry');
...
Route::any('/imageUploads1', 'sws_Admin\ProductController@imageUploads1')->name('imageUploads1');
Route::any('/edit_qa/{id}', 'sws_Admin\ProductController@edit_qa')->name('edit_qa');

Route::post('/uploadzipfile', 'sws_Admin\ProductController@uploadzipfile')->name('uploadzipfile');
Route::any('/view-product-images', 'sws_Admin\ProductController@viewProductImages')->name('view-product-images');
Route::get('/getfoldername', 'sws_Admin\ProductController@getfoldername')->name('getfoldername');
Route::get('/deletefolder', 'sws_Admin\ProductController@deletefolder')->name('deletefolder');
Route::get('/serachfoldername', 'sws_Admin\ProductController@serachfoldername')->name('serachfoldername');
Route::post('/multideleteimages', 'sws_Admin\ProductController@multideleteimages')->name('multideleteimages');
Route::get('/viewspageimages/{userid}/{folderid}', 'sws_Admin\ProductController@viewspageimages')->name('viewspageimages');
Route::any('/product-images', 'sws_Admin\ProductController@ProductImages')->name('product-images');
