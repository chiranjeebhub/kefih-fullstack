...
Route::get('/vendor_order_tcs_print_vendor_invoice/{tcs_invoice_no}/{type}', 'sws_Admin\VendorOrderController@vendor_order_tcs_print_vendor_invoice')->name('vendor_order_tcs_print_vendor_invoice');
