			...
			<td style="vertical-align: top; padding: 30px;">
				<table cellpadding="0" cellspacing="0" style="width: 100%;">
					...
					<tr bgcolor="#ebecec">
						...
						<td style="text-align: right;">18up.in Order id : 0000000000000</td>
					</tr>
				</table>
			</td>
...
<span style="font-size: 12px; font-weight: normal;">For Shopping With Us</span></td>
		...
		<tr>
			<td style="padding: 20px 30px;">
				<p style="font-size: 13px; margin-top: 5px; font-style: italic; line-height: 24px;"><strong style="font-style: normal;">Returns Policy</strong> : At 18up.in we try to deliver perfectly each and every time. But in the off-chance that you need to return the item, please do so with the original Brand box/price tag, original packing and invoice without which it will be really difficult for us to act on your request. Please help us in helping you. Terms and conditions apply.<br/>
