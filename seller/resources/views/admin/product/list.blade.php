	...
	?>
		...
		<div class="">
			...
			<div class="col-sm-12 mt15">
				...
				<br>
				  <input type="hidden" value="43" id="ProductVendor">
...
<form role="form" class="form-element resetAbleForm" action="{{ route('bulk_upload_product') }}" method="post" enctype="multipart/form-data">
			   @csrf
					...
					<div class="form-group">
						...
						<input type="hidden" name="vendor" value="43">
					</div>
...
<a href="<?php echo Config::get('constants.Url.public_url'); ?>public/Simple_product.csv">mmmSimple Product Upload CSV</a>&nbsp;|&nbsp;<a href="{{ asset('public/Configurable_product.csv') }}">Configurable Product Upload CSV</a>
  ...
  @csrf
					  ...
					  @foreach($products as $key=>$product)
						...
						<tr>
						 ...
						 <td style="width:20%">{{$product->hsn_code}}</td>
							...
							>
								<i class="fa fa-pencil text-blue" aria-hidden="true"></i>Edit
								</a>&nbsp;|&nbsp;
        ...
        @csrf
            <div class="row">
                    ...
                    <div class="col-md-6">
                        <input type="hidden" name="product_vendor" value="43"> 
     ...
     <div class="modal-body">
        ...
        @csrf
            <div class="row">
                ...
                <div class="col-md-6">
                    <select name="product_type" class="form-control">
                    <option value="0">Feature Products</option>
