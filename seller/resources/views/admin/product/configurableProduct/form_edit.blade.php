										 ...
										 <div id="recipeCarousel{{$attr['color_id']}}" class="recipeCarousel carousel slide" data-ride="carousel" data-type="multi" data-interval="false" >
											...
											<?php $a = 1; ?>
												...
												<div class="carousel-item <?php echo ($a==1)?'active':''; ?>">
													<div class="col-md-2">
													 <!--<img class="img-fluid" src="<?php echo Config::get('constants.Url.public_url'); ?>uploads/products/{{$row->product_config_image}}">-->
        ...
        >{{$extra_option->filter_value}}</option>
            ...
            @endforeach
								...
								@endif
									...
									<!--<h4><label for="exampleInputEmail1">Legal Information</label></h4>-->
