...
@section('content')
    ...
    <!-- Main content -->
	  ...
	  <div class="row">
        ...
        <!-- /.col -->
        <div class="col-xl-3 col-md-6 col-12 ">
             <a href="{{ route('sorders',base64_encode(0)) }}">
        ...
        <div class="col-xl-3 col-md-6 col-12">
            <a href="{{ route('vendors') }}">
              ...
              <div class="box-body">
                ...
                <div class="text-center my-2">
                  <div class="font-size-60 text-white">{!! App\Helpers\CommonHelper::vendorCount(); !!}</div>
              ...
              <div class="box-body bg-gray-light py-12">
                ...
                <!--<span class="text-dark">{!! App\Helpers\CommonHelper::vendorCount(); !!}</span>-->
              </div>

              <div class="progress progress-xxs mt-0 mb-0">
                <div class="progress-bar bg-success" role="progressbar" style="width: 55%; height: 3px;" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            </a>
        </div>
		...
		<div class="col-xl-3 col-md-6 col-12">
			...
			<div class="box bg-warning">
			  ...
			  <div class="box-body bg-info py-12">
				<!--<span class="text-muted mr-1">Completed:</span>-->
				<!--<span class="text-dark">{!! App\Helpers\CommonHelper::customerCount(0); !!}</span>-->
			  </div>

			  <div class="progress progress-xxs mt-0 mb-0">
				<div class="progress-bar bg-info" role="progressbar" style="width: 55%; height: 3px;" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100"></div>
			  </div>
			</div>
			 </a>
		</div>
         ...
         <div class="col-xl-3 col-md-6 col-12 ">
             <a href="{{ route('reports',base64_encode(3)) }}">
          	<div class="box bg-danger">
              <div class="box-body">
                <div class="flexbox">
                  <h5>Best Vendors</h5>
