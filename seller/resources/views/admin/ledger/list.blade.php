				...
				<div class="row">
					...
					<div class="col-md-5">
						...
						<div class="searchmain">
							...
							<button type="submit" class="btn btn-primary vendorLedger" >Search</button>
						</div>
					</div>
				</div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($ledgers as $row)
                            ...
                            <tr>
                                ...
                                <td>{{ $netAmountsale - $paid_amount->total_paid_amt - (number_format($tcs_amt,2) + number_format($tds_amt,2))  }}</td>
