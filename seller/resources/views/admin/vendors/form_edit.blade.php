    ...
    <div class="container">
        <div class="row">
                                    ...
                                    <div class="fields">
										<div class="row">
											...
											<div class="col-sm-2">
												...
												<br><span class="text-warning">(Size: <?php echo Config::get('constants.size.vendor_profile_image_min'); ?>kb – <?php echo Config::get('constants.size.vendor_profile_image_max'); ?>kb)</span>
											</div>
											<div class="col-sm-12">
			...
			<div class="tab-pane <?php echo ($parameters_level==2)?'active show':''; ?> " id="company_info" role="tabpanel" aria-expanded="false">                               
					<form role="form" action="{{route('edit_vendor', [base64_encode(2),base64_encode($id)])}}" method="post" enctype="multipart/form-data">
					@csrf                                  
						<div class="pad">
						<h4 class="skin-purple-light">Company Info</h4>
							<div class="fields">
								<div class="row">
									...
									<br>	<span class="text-warning">(Size: <?php echo Config::get('constants.size.vendor_company_logo_min'); ?>kb – <?php echo Config::get('constants.size.vendor_company_logo_max'); ?>kb)</span>
		...
		<div class="tab-pane <?php echo ($parameters_level==3)?'active show':''; ?> " id="support_info" role="tabpanel" aria-expanded="false">                               
			<form role="form" action="{{route('edit_vendor', [base64_encode(3),base64_encode($id)])}}" method="post" id="vendor_support_info"  enctype="multipart/form-data">
			@csrf                                  
				<div class="pad">
					...
					<div class="fields">
						<div class="row">
							...
							<div class="col-sm-6">
								...
								<span class="text-warning" >Ex: https://www.facebook.com/18upfashions/</span>
							</div>
							<div class="col-sm-6">
								{!! App\Helpers\CustomFormHelper::form_builder($page_details['Form_data']['Form_field']['vendor_support_tw_field']); !!}
							    <span class="text-warning" >Ex: 	https://twitter.com/18upfashions</span>
							</div>
							<div class="col-sm-12">
								{!! App\Helpers\CustomFormHelper::form_builder($page_details['Form_data']['Form_field']['submit_button_field']); !!}
							</div>
