...
<section class="product-nav-details">
    <div class="container">
        <div class="row">
                ...
                <!-- Tab panes -->
                        ...
                        <div class="tab-content">
							...
							<form role="form" action="{{ $page_details['Action_route']}}" method="post" enctype="multipart/form-data" id="add_vendor_general_info">
							  @csrf
                                <div class="pad">
		...
		<div class="tab-pane <?php echo ($parameters_level==3)?'active show':''; ?> " id="support_info" role="tabpanel" aria-expanded="false">                               
			<form role="form" action="{{ $page_details['Action_route']}}" method="post" id="vendor_support_info" enctype="multipart/form-data">
			@csrf                                  
				<div class="pad">
