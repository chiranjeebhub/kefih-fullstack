                ...
                <table cellpadding="0" cellspacing="0" style="padding: 15px; background: #fff; width:100%; margin: -5px auto;">
                    <tr bgcolor="#231f20">
						<td style="text-align: center; padding: 5px 0;">
							<a href="https://www.phaukat.com/"><img width="200px;" src="{{ asset('public/fronted/images/mailr-logo.png') }}"></a>
						</td>
					</tr>
...
margin-left: 10px;">
                            ...
                            <a href="https://www.instagram.com/phaukatofficial/?hl=en" target="_blank"><img title="Instagram" width="30px;" src="{{ asset('public/fronted/images/instagram-icon.png') }}"></a></span></p>
						</td>
					</tr>					
                </table>                
            </td>               
