    ...
    <table style=" width: 75%; margin: 40px auto; font-family:Cambria, 'Hoefler Text', 'Liberation Serif', Times, 'Times New Roman', serif;">
        ...
        <tr>
            <td>
                <table cellpadding="0" cellspacing="0" style="padding: 15px; background: #fff; width:100%; margin: -5px auto;">
                    <tr bgcolor="#231f20">
						<td style="text-align: center; padding: 5px 0;">
							...
							<a href="https://www.phaukat.com/"><img width="200px;" src="https://www.phaukat.com/public/fronted/images/mailr-logo.png"></a>
						</td>
					</tr>
								...
								<div><p style="text-align:center; "><img width="120px" src="https://www.phaukat.com/public/fronted/images/confirmed-icon.png"></p>
                                            ...
                                            <tr>
												<td>
													...
													<p style="margin: 0;"><strong><a href="https://www.phaukat.com/">phaukat.com</a></strong></p>
												</td>
											</tr>
                                            <tr>
				...
				<span style="color: #1aa4bb;">Rs. 25</span>
			 ...
			 <?php if(@$extra_info->deduct_reward_points!=''){ ?>
					<p style="margin: 0 0 10px; font-size:16px; color:#6a6969;">Paukat coins<span style="text-align: right; float: right;"> 
				...
				<span style="color: #1aa4bb;">Rs. {{@$extra_info->deduct_reward_points}}</span>
					...
					<tr bgcolor="#231f20">
						<td>
							<ul style="display:inline-block; width:100%; ">
								<li align="left" style="color: #ee1d23; font-size: 18px; float: left; margin-right:38px;"><a style="font-size: 20px; color: #fff; text-decoration: none;" href="{{route('refer_and_earn')}}" target="_blank">REFER AND EARN</a></li>
					...
					<tr>
						<td><p style="font-size:18px; line-height:24px;">#1249, First floor, Vittal square 24th main road, Hsr layout 2nd sector, Bangalore-560102 <br/>E-mail us: <a style="color:#000;" href="mailto:connect@phaukat.com">connect@phaukat.com</a></p>
...
margin-left: 10px;">
							<a href="https://twitter.com/phaukatofficial" target="_blank"><img title="Twitter" width="30px;" src="{{ asset('public/fronted/images/twitter-icon.png') }}"></a> 
							<a href="https://www.snapchat.com/add/phaukatofficial" target="_blank"><img title="Snapchat" width="30px;" src="{{ asset('public/fronted/images/snapchat-icon.png') }}"></a> 
							<a href="https://www.facebook.com/phaukatofficial/" target="_blank"><img title="Facebook" width="30px;" src="{{ asset('public/fronted/images/facebook-icon.png') }}"></a> 
                            <a href="https://www.instagram.com/phaukatofficial/?hl=en" target="_blank"><img title="Instagram" width="30px;" src="{{ asset('public/fronted/images/instagram-icon.png') }}"></a>
                            </span></p>
						</td>
					</tr>
