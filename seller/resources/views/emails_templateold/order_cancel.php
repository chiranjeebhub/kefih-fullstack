...
<head>
    ...
    <title>Order <?php echo @$data['operation_process']; ?></title>
                                ...
                                <tr>
                                    <td style="padding: 5px 0px; ">
                                        <table cellpadding="0" cellspacing="0" style="width: 100%; font-size:17px; padding: 20px;">
                                            <tr>
												<td>
													<h1 style="margin: 10px 0 10px; font-size: 24px; letter-spacing: 1px; word-spacing: 2px; text-align: center; text-transform:uppercase;"><?php echo @$data['operation_process']; ?> Order</h1>
												</td>
											</tr>
											<tr>
												<td>
													<p style="margin: 10px 0;">Hi <?php echo ucfirst($data['customer_fname'].' '.$data['customer_lname']); ?>,</p>
													<p style="margin: 10px 0;">We have processed your <?php echo @$data['operation_process']; ?> request for your order.</p>
													<p style="margin: 15px 0 0;">Thank you,</p>
													<p style="margin: 10px 0 40px;"><strong>Phaukat</strong>.Com</p>
												</td>
											</tr>
                                            <tr>
													...
													<table cellpadding="0" cellspacing="0" style="width: 100%; border: solid 1px #e6e6e6;">
														<tr bgcolor="#fff">
															<td>
																<table cellpadding="0" cellspacing="0" style="width: 100%;">
																	<tr>
																		<td><img style="float: left;" width="150px;" src="https://www.phaukat.com/uploads/products/240-180/<?php echo $data['product_details']['product_image']; ?>" />
																		</td>
												...
												<td>
													<table cellpadding="0" cellspacing="0" style="width: 100%; border-top: solid 2px #ff000085; border-bottom: solid 2px #ff000085; padding:20px 0; margin-bottom: 20px;">
														...
														<tr>
															...
															<?php 
															         //  $p_price =  $data['product_details']['product_price']*$data['product_details']['product_qty'];
													                 $p_price = (intval($data['product_details']['product_qty'])*intval($data['product_details']['product_price']))+$data['product_details']['order_shipping_charges']+$data['product_details']['order_cod_charges']-$data['product_details']['order_coupon_amount']-$data['product_details']['order_wallet_amount'];
                                                            
															?>
															<p style="margin: 15px 0 10px; font-size:16px; color:#000; font-weight:bold; border-top: solid 1px #ccc; padding: 10px 0 0px;">Total<span style="text-align: right; float: right;"><i class="fa fa-inr"></i> <?php echo $p_price; ?> </span></p>
				...
				<tr bgcolor="#231f20">
                    <td>
                        <ul style="display:inline-block; width:100%; ">
                            <li align="left" style="color: #ee1d23; font-size: 18px; float: left; margin-right:38px;"><a style="font-size: 20px; color: #fff; text-decoration: none;" href="https://www.phaukat.com/refer_and_earn" target="_blank">REFER AND EARN</a></li>
                            <li align="left" style="color: #ee1d23; font-size: 18px; float: left;  margin-right:38px;"><a style="font-size: 20px; color: #fff; text-decoration: none;" href="https://www.phaukat.com/page/about_us" target="_blank">ABOUT US</a></li>
                            <li align="left" style="color: #ee1d23; font-size: 18px; float: left; "><a style="font-size: 20px; color: #fff; text-decoration: none;" href="https://www.phaukat.com/page/terms" target="_blank">TEARM & CONDITIONS</a></li>							
                        </ul>							
                    </td>
                </tr>
                <tr>
                    <td>
                        <p style="font-size:18px; line-height:24px;">Arbizon ecommerce India pvt ltd, Ground floor, sf no . 133-134, road, Lic colony 1st street, college road , Tiruppur , Tirupur , Tamilnadu -641603 <br/>E-mail us: <a style="color:#000;" href="mailto:connect@phaukat.com">connect@phaukat.com</a></p>
                        ...
                        margin-left: 10px;">
                        <a href="https://twitter.com/phaukatofficial" target="_blank"><img title="Twitter" width="30px;" src="https://www.phaukat.com/public/fronted/images/twitter-icon.png"></a> 
                        <a href="https://www.snapchat.com/add/phaukatofficial" target="_blank"><img title="Snapchat" width="30px;" src="https://www.phaukat.com/public/fronted/images/snapchat-icon.png"></a> 
                        <a href="https://www.facebook.com/phaukatofficial/" target="_blank"><img title="Facebook" width="30px;" src="https://www.phaukat.com/public/fronted/images/facebook-icon.png"></a> 
                        <a href="https://www.instagram.com/phaukatofficial/?hl=en" target="_blank"><img title="Instagram" width="30px;" src="https://www.phaukat.com/public/fronted/images/instagram-icon.png"></a></span></p>
                    </td>
                </tr>
					</tr>
