...
<div class="">
	<div class="allbutntbl">
		<a href="{{ route('addphaukat_offers') }}" class="btn btn-success"><i class="fa fa-plus" aria-hidden="true"></i> Add Phaukat Offers</a>
	</div>
	<!--<div class="col-sm-12">
		<div class="row">
			<div class="col-sm-2">
					...
					<tbody>
					  ...
					  @foreach($Whatsmore as $Blog)
						...
						<tr>
							...
							<td>
							<a href="{{route('phaukat_offers_sts',[base64_encode($Blog->id),base64_encode($Blog->status)] )}}"
									...
									&nbsp;|&nbsp;
							<a href="{{route('editphaukat_offers', base64_encode($Blog->id))}}">
								<i class="fa fa-pencil text-blue" aria-hidden="true"></i>
								</a>&nbsp; | &nbsp;
							<a href="{{route('deletephaukat_offers', base64_encode($Blog->id))}}"
