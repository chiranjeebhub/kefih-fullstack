		...
		<div class="row">
			<div class="col-sm-6">
				<div class="form-group brandmain">
					...
					@endif
					<span class="text-warning">(Size: <?php echo Config::get('constants.size.offer_image_min'); ?>kb – <?php echo Config::get('constants.size.offer_image_max'); ?>kb <?php echo Config::get('constants.size.offer_image_dimensions'); ?> )</span>
