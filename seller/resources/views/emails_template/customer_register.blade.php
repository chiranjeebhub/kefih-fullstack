					...
					<tr bgcolor="#231f20">
						<td>
							<ul style="display:inline-block; width:100%; ">
								...
								<li align="left" style="color: #d01f27; font-size: 18px; float: left; "><a style="font-size: 20px; color: #fff; text-decoration: none;" href="{{route('page_url',['terms'])}}" target="_blank">TEARM & CONDITIONS</a></li>							
							</ul>							
						</td>
					</tr>
					<tr>
...
margin-left: 10px;">
							...
							<a href="https://www.facebook.com/Rredlipsofficial/" target="_blank"><img title="Facebook" width="30px;" src="{{ asset('public/fronted/images/facebook-icon.png') }}"></a> 
