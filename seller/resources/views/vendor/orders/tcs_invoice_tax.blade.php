        ...
        <div style=" margin-top: 20px; margin-bottom: 30px;clear:both;">
                ...
                <div class="maindiv" style="padding: 0x; background: #fff; ">
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        ...
                        <tr>
                            <td colspan="6">
                                <h3> Seller Commission Invoice</h3>
                            </td>
                            
                        </tr>
                        
                        <tr><td colspan="2"><h1>BTA Prime Private Limited</h1></td><td rowspan="4" colspan="4" style="text-align: center;"><img class="logo" style="width:250px;" src="{{ asset('public/fronted/images/logo.jpg') }}" /></td></tr>
                        ...
                        <tr><td><h2>Bill to</h2></td><td style="width: 100px;">&nbsp;</td><td colspan="3"><h2 style="font-weight: 700;">Invoice Number</h2></td><td><h2>{{$Order[0]['tcs_invoice_no']}}</h2></td></tr>
                        <tr>
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%;">
                        <tr>
                            ...
                            <th style="border-top:none;">Jaldi Kharido Fee Fee Slab %</th>
                            <th style="border-top:none;">Jaldi Kharido Fee Fee Amount</th>
                            <th style="border-top:none;">Gst Slab</th>
                            <th style="border-top:none;">GST {{$service_tax}}% on Jaldi Kharido Fee fee</th>
                            <th style="border-top:none;">Amount Payable After Jaldi Kharido Fee fee</th>
                             
                        </tr>
                        <?php
                            $total_order_amt=$total_comission_amt=$total_comission_amt_with_tax=$total_final_amt=$total_tcs_amt=$tcs_percentage=0;
                        ...
                        <tr bgcolor="#000">
                            ...
                            <td style="color:#fff;"><strong>{{number_format(($total_final_amt-$total_tcs_amt),2)}}</strong></td>
                        </tr>
                        <tr><td colspan="5"><strong>	
                        {!! App\Helpers\CommonHelper::convert_number_to_words(round(($total_final_amt-$total_tcs_amt))); !!} Rupee Only</strong></td><td colspan="3"><strong>For BTA Prime Private Limited</strong>	</td></tr>
                        <!--<tr><td colspan="5">This a Settlement Voucher not an Invoice, incase of any issue do let us know on 0000000000</td><td colspan="3"></td></tr>-->
                    </table>
