					...
					<thead>
                        ...
                        <tbody>
                            ...
                            <tr>
    						    ...
    						    <td> 
                                    <a href="{{ route('vendor_order_tcs_print_invoice',[base64_encode($order->vendor_id),base64_encode($order->tcs_invoice_no)]) }}" class="btn btn-success btn-small">Print TCS Settlement Invoice </a>
									<a href="{{ route('vendor_order_tcs_print_vendor_invoice',[base64_encode($order->tcs_invoice_no),'true']) }}" class="btn btn-success btn-small">Seller Commission Invoice </a>
