			  ...
			  <div class="box bg-transparent no-border no-shadow">
				...
				<div class="box-body b-1">
				  ...
				  <div class="mailbox-read-message">
					  <div class="row">
					  <form method="post" action="{{route('vendor_order_shipping_extradetails',base64_encode($Order[0]['id']))}}">
					  @csrf
					  <input type="submit" value="Shipping" style="float:right">
					...
					<thead>
						<tr>
							...
							<th>Price</th>
							<th>Total</th>
							<th>SELECT PRODUCTS FOR PICKUP</th>
						</tr>
					</thead>
					<tbody>
					<?php $i=1 ?>
					  @foreach($Order as $row)
						...
						<tr>
							...
							@endif()
								...
								<td><input type="checkbox" name="select_check[]" value="{{$row['order_detail_id']}}"></td>
