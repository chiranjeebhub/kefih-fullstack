...
<div style="width:1100px; margin-left:auto; margin-right:auto;">
    ...
    <div style="width:88%; margin-left:auto; margin-right:auto; margin-top: 30px; margin-bottom: 30px;">
			...
			<td style="vertical-align: top; padding: 30px;">
				<table cellpadding="0" cellspacing="0" style="width: 100%;">
					...
					<tr bgcolor="#ebecec">
						...
						<td style="text-align: right;">Phaukat Order Id : {{ucwords($Order[0]['order_no'])}}</td>
					</tr>
				</table>
			</td>
			...
			<td style="padding: 30px; text-align: left; background: #fff">
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #737373; font-size: 14px;">
					...
					<tr>
					  	...
					  	<td style=" padding-left: 20px;">Order Date : {{ date('d-m-Y',strtotime($Order[0]['order_date']))}}
						<br><br>
				...
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #737373; border-top:none; font-size: 14px;">
					...
					<tr>
						<td style="border-right: solid 1px #737373; padding-left: 20px;">Buyer Name : {{ ucfirst($Order[0]['order_shipping_name'])}}</td>
					  	<td style=" padding-left: 20px;"><!--Buyer Name {{ ucwords($user_data->name)}}--> 
						Buyer Name : {{ ucfirst($Order[0]['order_shipping_name'])}}</td>
					</tr>
					<tr>
						 ...
						 {{$Order[0]['order_shipping_state']}}</td>
					  	<td style=" padding-left: 20px;"><!--Address {{ ucwords($user_data->address)}} {{ ucwords($user_data->address1)}} {{ ucwords($user_data->address2)}} {{ucwords($user_data->city)}} {{ ucwords($user_data->state)}}-->
					...
					<tr>
					  	...
					  	<td style=" padding-left: 20px;"><!--Pin :  {{ $user_data->pincode}}--> Pin : {{ ucfirst($Order[0]['order_shipping_zip'])}}</td>
					</tr>
					<tr>
					  	<td style="border-right: solid 1px #737373; padding-left: 20px;">Ph. : {{ $Order[0]['order_shipping_phone']}}</td>
					  	<td style=" padding-left: 20px;"><!--Ph. :  {{ ucwords($user_data->phone)}}--> Ph. : {{ $Order[0]['order_shipping_phone']}}</td>
					</tr>
					<!--<tr bgcolor="#ebecec">
				...
				<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #000333; font-size: 14px;">
					<tr bgcolor="#ebecec">
					  	...
					  	<th style="border-right: solid 1px #000333; font-size: 14px; padding-left: 20px;">Qty.</th>
						<th style="border-right: solid 1px #000333; font-size: 14px; padding-left: 20px; font-weight: normal;">MRP Price(Rs.)</th>
						<th style="border-right: solid 1px #000333; font-size: 14px; padding-left: 20px; font-weight: normal;">Selling Price(Rs.)</th>
						<th style="border-right: solid 1px #000333; font-size: 14px; padding-left: 20px; font-weight: normal;">Discount(Rs.)</th>
						<th style="border-right: solid 1px #000333; font-size: 14px; padding-left: 20px; font-weight: normal;">Unit Price(Rs.)</th>
						<!--<th style="border-right: solid 1px #000333; font-size: 14px; padding-left: 20px;">Discount</th>-->
						<th style="border-right: solid 1px #000333; font-size: 14px; padding-left: 20px; font-weight: normal;">Tax Rate(%)</th>
					...
					<?php $total=$cod_total=$ship_total=$wallet_total=$coupon_total=0;?>
					...
					<tr>
						<td style="border-right: solid 1px #000333; padding-left: 20px;">
					  	...
					  	<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{$row['product_qty']}}</td>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{number_format($row['product_price_old'],2)}}</td>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{number_format($row['product_price'],2)}}</td>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{number_format(($row['product_price_old']-$row['product_price']),2)}}</td>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{number_format($tax_free_amt,2)}}</td>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;"><?php echo $product_tax;?></td>
						
						<?php if($tax_column==1){?>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{number_format($tax_amt,2)}}</td>
						<?php } else if($tax_column==2){?>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{number_format(($tax_amt/2),2)}}</td>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{number_format(($tax_amt/2),2)}}</td>
						<?php }?>
					...
					<tr>
					  	<td style="border-right: solid 1px #000333; padding-left: 20px;">Shipping Charges</td>
					  	<td style=" padding-left: 20px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">&nbsp;</td>
						<td style=" padding-left: 20px; border-right: solid 1px #000333;">&nbsp;</td>
					...
					<tr>
						...
						<?php }?>
						<td style="font-size: 14px; padding-left: 20px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td>
						<td style="font-size: 14px; padding-left: 20px; border-top: solid 1px #000333;">{{number_format(($total+$ship_total),2)}}</td>
					</tr>
					...
					<tr>
						...
						<?php }?>
						<td style="font-size: 14px; padding-left: 20px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td>
						<td style="font-size: 14px; padding-left: 20px; border-top: solid 1px #000333;">{{number_format($cod_total,2)}}</td>
					</tr>
					<?php }?>
					...
					<tr>
						...
						<?php }?>
						<td style="font-size: 14px; padding-left: 20px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td> 
						<td style="font-size: 14px; padding-left: 20px; border-top: solid 1px #000333;">{{number_format(round(($total+$ship_total+$cod_total-$wallet_total-$coupon_total)),2)}}</td>
					</tr>
				</table>
			</td>	
		</tr>
		<tr>
			<td bgcolor="#ebecec" style="font-size: 16px; font-weight: bold; padding: 15px 30px;">
				Total amount In words.
					{!! App\Helpers\CommonHelper::convert_number_to_words(round($total+$ship_total+$cod_total-$wallet_total-$coupon_total)); !!} 
				Rupee Only
			</td>	
		</tr>
		<tr>
				...
				<table cellpadding="0" cellspacing="0" style="width: 100%; border-bottom: solid 1px #ddd; padding-bottom: 10px;">
					<tr>
						<td style="width: 80%; vertical-align: top;">
							<p>Wheather tax is payable under reverse charge-No</p>
						...
						<td style="font-size: 14px; text-align: center; width: 20%; line-height: 28px;">For {{$vdr_data['company_name']}} <span style="width: 200px; height: 60px; display: inline-block; border: solid 1px #333;">&nbsp;</span> Authorized Signatory</td>
					</tr>
				</table>
			</td>
		...
		<tr>
			<td style="float: right; padding: 40px 30px 20px; text-align: center;"><img src="{{ asset('public/fronted/images/logo.jpg') }}" /><h2 style="font-weight: 600; font-size: 18px; margin-bottom: 5px;">Thank You!</h2>
<span style="font-size: 12px; font-weight: normal;">For Shopping With Us</span></td>
		</tr>
		<tr>
			<td style="padding: 20px 30px;">
				<p style="font-size: 13px; margin-top: 5px; font-style: italic; line-height: 24px;"><strong style="font-style: normal;">Returns Policy</strong> : At Phaukat.com we try to deliver perfectly each and every time. But in the off-chance that you need to return the item, please do so with the original Brand box/price<br/>
...
Contact phaukat.com : connect@phaukat.com</p>
			</td>	
		</tr>
