    ...
    <section class="content">
	  <div class="row">
        ...
        <div class="col-xl-3 col-md-6 col-12 ">
              ...
              <div class="box-body">
                <div class="flexbox">
                  <h5><a href="{{ URL::to('/vendor_filters_products/'.auth()->guard('vendor')->user()->id.'/0/All/All/All/All/All') }}">Total Inactive Products</a></h5>
        ...
        <div class="col-xl-3 col-md-6 col-12 ">
              ...
              <div class="box-body">
                <div class="flexbox">
                  <h5><a href="{{ URL::to('/vendor_filters_products/'.auth()->guard('vendor')->user()->id.'/1/All/All/All/All/All') }}">Total Active Products</a></h5>
        ...
        <!-- /.col -->
         <div class="col-xl-3 col-md-6 col-12 ">
              ...
              <div class="box-body">
                ...
                <div class="text-center my-2">
                  <div class="font-size-60 text-white">	  {!! App\Vendor::orderCount(auth()->guard('vendor')->user()->id); !!}</div>
        ...
        <div class="col-xl-3 col-md-6 col-12 ">
              ...
              <div class="box-body">
                <div class="flexbox">
                  <h5><a href="{{ route('vendor_orders',base64_encode(4)) }}">Canceled Orders</a></h5>
