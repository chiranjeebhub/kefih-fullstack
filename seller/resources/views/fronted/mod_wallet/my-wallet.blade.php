							...
							<div class="tab-content">
							  <div class="tab-pane fade active in" id="totalearning">
								  ...
								  <div class="row">
                                                    ...
                                                    <h4>Coins <span><em class="fa fa-inr"></em> {{$row->fld_reward_points}}</span></h4>
                                                    </div>
                                                    </div>
                                            ...
                                            <h4>FOR </h4>
                                             ...
                                             @switch($row->mode)
                                                    ...
                                                    @case(1)
                                                    You have register from referarls
                                                    @break
                                                
                                                    @case(2)
                                                     You have earn from refery orders
                                                    @break
                                           ...
                                           @endswitch
                                                    ...
                                                    <div class="col-sm-4">
                                                    <div class="redlip-wallet">
                                                    <p class="date">Exp Date : <?php echo date('d M Y',strtotime($row->fld_wallet_date));?></p>
                                                    </div>
                                                    </div>
							  ...
							  <div class="tab-pane fade" id="creditshistory">
								  ...
								  <div class="col-sm-4">
								  <div class="redlip-wallet">
                                         <h4>Coins <span><em class="fa fa-inr"></em> {{$row->fld_reward_deduct_points}}</span></h4>
                                      </div>
                                      </div>
