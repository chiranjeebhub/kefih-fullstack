...
<link rel="shortcut icon" href="{{ asset('public/fronted/images/favicon.png') }}" type="image/x-icon" />
...
@include('vendor.includes.script')
    ...
    </script><script src="{{ asset('public/fronted/js/owl.carousel.js') }}"></script>
