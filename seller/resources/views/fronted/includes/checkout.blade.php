    <div class="shopping-cart" style="display: none;">
		...
		<ul class="shopping-cart-items">
		  <li>
			...
			<span class="item-price"><i class="fa fa-inr"></i> 849.99</span>
		  ...
		  <li>
			...
			<span class="item-price"><i class="fa fa-inr"></i> 1,249.99</span>
			<span class="item-quantity">Quantity: 01</span>
			<span class="item-remove"><a href="#"><i class="fa fa-trash"></i></a></span>
		  </li>
		  ...
		  <li>
			...
			<span class="item-price"><i class="fa fa-inr"></i> 129.99</span>
			<span class="item-quantity">Quantity: 01</span>
			<span class="item-remove"><a href="#"><i class="fa fa-trash"></i></a></span>
		  </li>
		</ul>
