...
<h6>Create Account</h6>
    ...
    @csrf
		...
		{!! App\Helpers\CustomFormHelper::form_builder($page_details['Form_data']['Form_field']['password_field']); !!}
			{!! App\Helpers\CustomFormHelper::form_builder($page_details['Form_data']['Form_field']['confirm_password_field']); !!}
		...
		<div class="paymnetthod">
			<div class="checkbox checkbox-circle">
				...
				<label for="test1">Have a Referal Code ?</label>
				<div id="dvPassport" style="display: none">
				<input class="form-control" type="text" name="r_code" value=" " placeholder="Referal Code"> 
			</div>
			</div>
		</div>
