			...
			<table cellpadding="0" cellspacing="0" style="width:100%; font-family: 'Be Vietnam', sans-serif; padding:0px; background: #fff; ">    
				<tr bgcolor="#ebecec">
					<td class="headertbl" style="vertical-align: top;">			
						...
						<table cellpadding="0" cellspacing="0" style="width: 100%;">
							<tr>
								<td><span>Invoice number : {{$order->order_detail_invoice_num}} </span> <span style="float:right;">Phaukat Order id : {{$master_order->order_no}} <!--& Item Id : {{$order->id}}--></span></td>
							</tr>
						</table>				
					</td>
				</tr>
					...
					<td class="sellerInvc" style="text-align: left; background: #fff">
						...
						<table cellpadding="7px" cellspacing="0" style="width: 100%; border: solid 1px #737373; font-size: 12px;">
							<tr bgcolor="#ebecec">
								...
								<th style="border-right: solid 1px #000333; font-size: 10px;">MRP Price(Rs.)</th>
								<th style="border-right: solid 1px #000333; font-size: 10px;">Selling Price(Rs.)</th>
								<th style="border-right: solid 1px #737373; font-size: 10px;">Discount</th>
								<th style="border-right: solid 1px #737373; font-size: 10px;">Unit Price(Rs.)</th>
							...
							<tr>
								...
								<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{number_format($order->product_price_old,2)}}</td>
								<td style=" padding-left: 20px; border-right: solid 1px #000333;">{{number_format($order->product_price,2)}}</td>
								<td style=" padding-left: 5px; border-right: solid 1px #737373;">{{$order->product_price_old-$order->product_price}}</td>
							...
							<tr>
								...
								<td style="font-size: 12px; padding-left: 5px; border-top: solid 1px #737373;">
									{{(number_format(($order->product_qty*$order->product_price+$order->order_cod_charges),2))}}
								</td>
							</tr>
							...
							<tr>
								...
								<?php }?>
								<td style="font-size: 14px; padding-left: 5px; border-top: solid 1px #000333; border-right: solid 1px #000333;">&nbsp;</td>
								<td style="font-size: 14px; padding-left: 5px; border-top: solid 1px #000333;">{{number_format(round(($total+$ship_total+$cod_charges-$wallet_total-$coupon_total)),2)}}</td>
							</tr>
						</table>
					</td>	
				</tr>
				<tr>
					<td bgcolor="#ebecec" style="font-size: 16px; font-weight: bold; padding: 5px 20px;">
						...
						{!! App\Helpers\CommonHelper::convert_number_to_words(($order->product_qty*$order->product_price)+$ship_total+$cod_charges-$wallet_total-$coupon_total); !!}
						Rupee
					</td>	
				</tr>
				<tr>
				...
				<tr>
					<td style="float: right; padding: 15px 5px 15px; text-align: right;">
						<img src="{{ asset('public/images/p_logo.png') }}" style="width:85px; height:40px;" />
				...
				<tr>
					<td style="padding: 5px 15px;">
						<p style="font-size: 12px; margin-top: 5px; font-style: italic; line-height: 16px;"><strong style="font-style: normal;">Returns Policy</strong> : At Phaukat.com we try to deliver perfectly each and every time. But in the off-chance that you need to return the item, please do so with the original Brand box/price tag, original packing and invoice without which it will be really difficult for us to act on your request. Please help us in helping you. Terms and conditions apply. The goods sold as are intended for end user consumption and not for re-sale.<br/>Contact phaukat.com : connect@phaukat.com</p>
					</td>	
				</tr>                
			</table>
		</div>
