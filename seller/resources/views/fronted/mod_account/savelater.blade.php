...
<a href="javascript:void(0)">Save Later</a>
@endsection  
...
<h6 class="fs18 fw600 mb20">Save Later</h6> 
  ...
  <div class="db-2-main-com db-2-main-com-table">
							...
							<div class="table wishlistlst" id="results">
							  <div class="theader">
                                ...
                                <div class="table_header">Cart</div>
								<div class="table_header">Remove</div>
							  </div>
							
							<?php if(@$savelater_data[0]->id!=''){ $i=1;foreach($savelater_data as $row){
								
							$attr_obj=new App\ProductAttributes(); 
							$attr_data=$attr_obj->getProductAttributes($row->id);
								
							?>
							  <div class="table_row" id="tableRow_{{$row->fld_save_later_id}}">
    ...
    <button class="buttonnone"><span> <i class="fa fa-trash-o delete deleteItemFromSavelater"  	prd_id='{{$row->fld_save_later_id}}' aria-hidden="true"></i></span></button>
                                    </div>
								</div>
							  </div>
							<?php }}else{ ?>
