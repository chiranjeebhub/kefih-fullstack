	    ...
	    $compared_product=array(
	     array(
			 ...
			 ,
	          array(
                'page_name'=>'About Us',
                'page_url'=>$this->site_base_path.'api/page/about'
	         )
			 ,
	          array(
                'page_name'=>'Delivery',
                'page_url'=>$this->site_base_path.'api/page/delivery'
	         )
			 ,
	          array(
                'page_name'=>'Payment',
                'page_url'=>$this->site_base_path.'api/page/payment'
	         )
			 ,
	          array(
                'page_name'=>'Help',
                'page_url'=>$this->site_base_path.'api/page/help'
	         )
			 ,
	          array(
                'page_name'=>'Terms & Conditions',
                'page_url'=>$this->site_base_path.'api/page/terms_conditions'
	         )
			 
			 ,
	          array(
                'page_name'=>'Exchange',
                'page_url'=>$this->site_base_path.'api/page/exchange'
	         )
	        );
