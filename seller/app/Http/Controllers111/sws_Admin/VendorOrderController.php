    ...
    {$pikup_list =array();
     ...
     $isReplaced=DB::table('replace_order_details')
        ...
        $PickupRequestData = array(
                                ...
                                'pickup_company_name'=>'Phaukat.com',
                                ...
                                'delivery_email' =>  'connect@phaukat.com',
                             );
   ...
   public function index(Request $request)
    {
		    ...
		    $vendors=array();
                ...
                $daterange=$request->daterange;	
                 /*if( $daterange==''){
                    $dt = date("d-m-Y");
                    $fr= date( "d-m-Y", strtotime( "$dt -7 day" ) );
                      $daterange=$fr.".". date('d-m-Y');
	...
	public function vendor_order_invoice(Request $request)
    {
	  ...
	  $Order =Orders::select(
			 ...
			 return view('vendor.orders.invoice_test',['Order'=>$Order,'page_details'=>$page_details,'vdr_data'=>$vdr_data]);	
    }
    ...
    {$pikup_list =array();
       ...
       // echo $vendor_info->name;die;
        ...
        $PickupRequestData = array(
                                ...
                                'pickup_landmark'=>'',
                                'pickup_contact'=>$vendor->phone,
                                //'pickup_email'=>'connect@phaukat.com',
                                'pickup_email'=>$vendor->email,
                                'delivery_landmark'=>'',
                                'package_content'=>$request->input('package_description'),
								'weight'=>$request->input('phy_weight'),
