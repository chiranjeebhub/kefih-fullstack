   ...
   return Redirect::back();
	...
	$type=base64_decode($request->type);
		...
		$products=Orders::
            ...
            ->where('order_details.order_status','3')->groupBy('products.id')->orderBy('total_price','desc')->paginate(30); 	
		}
		...
		$products=Orders::
            ...
            ->where('order_details.order_status','3')->groupBy('orders_shipping.order_shipping_zip')->orderBy('total_price','desc')->paginate(30); 	
		} 
		...
		$products=Orders::
            ...
            ->join('products','products.id','order_details.product_id')
            ->join('orders_shipping','orders_shipping.order_id','order_details.order_id')
            ->where('order_details.order_status','5')->groupBy('orders_shipping.order_shipping_zip')->orderBy('total_price','desc')->paginate(30); 	
		} 
		...
		$products=Orders::
            ...
            ->where('order_details.order_status','3')->groupBy('vendors.id')->paginate(30); 	
...
////////////////////////////////////////////
    ...
    $request->validate([
            ...
            'shipping_charge' => 'required|numeric|not_in:0|lt:cart_total'
...
'parent_amount.min'=>'Referal Amount  should greater then 0',
'child_amount.min'=>'Refery Amount  Amount  should greater then 0',
'parent_amount.not_in'=>'Referal Amount  should greater then 0',
'child_amount.not_in'=>'Refery Amount  Amount  should greater then 0',
"linkedin_url.max"=>"Instagram url should be less than 2000 charaters"
                ]
			);
			$data=array(
