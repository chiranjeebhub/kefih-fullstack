...
if ($request->isMethod('post')) {
    $input=$request->all();
          ...
          $request->validate([
              ...
              'blog_image' => 'required|mimes:jpeg,bmp,png|min:'.Config::get('constants.size.blog_image_min').'|max:'.Config::get('constants.size.blog_image_max').''
       ...
       $Blog = Blogs::find($id);
         $request->validate([
            'name' => 'required|unique:blogs,name,'.$id.',id,isdeleted,0',
             'description' => 'max:60000',
            'blog_image' => 'mimes:jpeg,bmp,png|min:'.Config::get('constants.size.blog_image_min').'|max:'.Config::get('constants.size.blog_image_max').''
