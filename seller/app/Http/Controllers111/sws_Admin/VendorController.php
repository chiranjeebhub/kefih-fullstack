 ...
 $page_details=array(
	 ...
	 if ($request->hasFile('profile_pic')) {
      ...
      if($Vendor->updateCategories($input,$request->session()->get('vendor_id'))){
		  ...
		  return Redirect::route('update_vdr_profile', [base64_encode(1),base64_encode($id)]);
            ...
            'company_city' => 'max:25',
            'company_pincode' => 'max:6|min:6|regex:/[1-9][0-9]{5}/',
			'about_us' => 'max:200',
	 ...
	 if ($request->hasFile('company_logo')) {
      ...
      if($Vendor->updateInvoiceInfo($input,$request->session()->get('vendor_id'))){
		 ...
		 return view('vendor.profile.edit',['page_details'=>$page_details,'vendor_data'=>$return_data]);
    ...
    public function search(Request $request)
		...
		$vendor_products=DB::table('vendor_existing_product')
			->select('vendor_existing_product.master_product_id','vendor_existing_product.product_id')
