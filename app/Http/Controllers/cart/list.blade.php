...
<nav class="mt15 new_ordertabs">
  <div class="nav nav-tabs" id="nav-tab" role="tablist">
	<a class="nav-item nav-link  <?php echo ($parameters_level==0)?'active':''; ?>"  href="{{ route('orders',base64_encode(0)) }}">New Orders </a>
	<?php /*
	...
	*/ ?>
	...
	<a class="nav-item nav-link <?php echo ($parameters_level==0)?'active':''; ?>"  href="{{ route('vendor_orders',base64_encode(0)) }}">Pending</a>
					...
					<?php $i=1;  ?>
					  @foreach($orders as $row)
						<tr>
							...
							<a href="{{ route('order_service_invoice',base64_encode($row->id)) }}" class="btn btn-info btn-small">Service Invoice</a>
