...
class CartController extends Controller 
{
     ...
     */ 
     public function city_selected(Request $request){
...
// 		 file_put_contents('cart'.date('Y-m-d H:i:s').'.txt',json_encode($input));
    ...
    public function cart_add_update(Request $request) {
	    ...
	    $record =Products::select('products.id')
		...
		if($action_type==0)	
		{
		    ...
		    $record=DB::table('cart')
                    ...
                    $msg="Product not avaialble in stock";
                    $code='404';
                    $error=1;
		     }
		...
		elseif($action_type==2){
            ...
            $error=1;	
            $msg="Product Is not available  in your city";
            $code='404';
    }
