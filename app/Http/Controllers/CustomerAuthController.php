        ...
        switch($type){
            case 0:
                if($customer->phone) {
                    ...
                    ->where('orders_shipping.order_shipping_phone', $customer->phone)
            ...
            case 3:
                if($customer->phone) {
                    ...
                    $orders=Orders::select('orders.*',
                        ...
                        DB::raw("( SELECT COUNT(*) FROM order_details where order_id=orders.id and order_status=3) as  isInvoiceGenerate ")
                    )
                    ->join('order_details','orders.id','order_details.order_id')
