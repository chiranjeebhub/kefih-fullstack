...
if ($request->isMethod('post')) {
    $input=$request->all();
          ...
          $request->validate([
              ...
              'logo_image' => 'required|mimes:jpeg,bmp,png,jpg|min:'.Config::get('constants.size.logo_min').'|max:'.Config::get('constants.size.logo_max').'',
              'banner_image' => 'required|mimes:jpeg,bmp,png,jpg|min:'.Config::get('constants.size.banner_min').'|max:'.Config::get('constants.size.banner_max').''
			...
			[
				...
				'logo_image.mimes'=>'Logo imag only support(jpeg,jpg,png)',
