...
class WhatsmoreController extends Controller
{
    ...
    public function lists(Request $request)
    {
       ...
       "Title"=>"My_offers",
       "Box_Title"=>"My offers",
		"search_route"=>URL::to('admin/my_offers_search'),
		"reset_route"=>route('my_offers')
     );
   ...
   public function add(Request $request){
     ...
     $page_details=array(
       "Title"=>"Add My Offers",
       "back_url"=>route('my_offers'),
	     "Method"=>"1",
       "Box_Title"=>"Add My Offers",
       "Action_route"=>route('addmy_offers'),
       "Form_data"=>array(
...
if ($request->isMethod('post')) {
   ...
   public function edit(Request $request)
   {
       ...
       "back_url"=>route('my_offers'),
	    "Method"=>"2",
       "Box_Title"=>"Edit",
       "Action_route"=>route('editmy_offers', base64_encode($id)),
       "Form_data"=>array(
            ...
            if ($res) {
              MsgHelper::save_session_message('success',Config::get('messages.common_msg.data_save_success'),$request);
                ...
                MsgHelper::save_session_message('danger',Config::get('messages.common_msg.data_save_error'),$request);
                    ...
                    return Redirect::route('my_offers');
    }
