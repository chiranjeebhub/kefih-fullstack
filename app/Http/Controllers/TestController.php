...
class TestController extends Controller
{
    ...
    public function testsms(){
        $mobile = ''; //put here mobile no to test. 
        $msg = 'Hello, Welcome to KEFIH! Your OTP code is 5456. - Kefih E-Commerce Private Limited';
        CommonHelper::msgCurlTest($mobile,$msg);
    }

    public function fbCoversion(Request $request){
        $orderID = $request->order_id;
        FbConversionHelper::fbCoversion($orderID, $request);
        /*
        $orderID = $request->order_id;
        if(!empty($orderID)){
        ...
        $url = 'https://graph.facebook.com/v17.0/1207340983414571/events?access_token=EAALc6cU3Cn4BAPflnKNZCa0kx8AKGYzvmiaCRFwmW5eam4YMaxYRg6XfRnaRQuNCmMw1o0dCPZCXWmaGRNFPty55IMwZByUf3XYjOm8HHmW2UhJxIsvr31MXeedZBatuBBAwc0w7tHGGdrkEdRhwmhZCf1zF37vudLkLnZAU9T4rn1k9QsgZAIcWnhavpdHdS8ZD';
        $ch = curl_init($url);
        ...
        /*
$ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://graph.facebook.com/v17.0/1207340983414571/events');
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
curl_setopt($ch, CURLOPT_POST, 1);
$post = array(
    'data' => [json_encode($purchaseEventData)],
...
*/
    ...
    public function testmail(){
        $email_data = [
            'to'=>'sudhir@b2cmarketing.in',
            'subject'=>'TestMail',
            "body"=>'<h1>This is testing message </h1>',          
         ];
