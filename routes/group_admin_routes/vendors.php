...
Route::group(['prefix' => 'admin'], function () {
     Route::get('/get-vendor-name', 'sws_Admin\VendorController@getVendorName')->name('getVendorName');
...
Route::any('/vendorfeaturemart/{id}', 'sws_Admin\AdminController@vendorfeaturemart')->name('vendorfeaturemart');
Route::any('/adminsizechart/{id}', 'sws_Admin\CategorysizechartController@adminsizechart')->name('adminsizechart');
Route::any('/vendornotfeaturemart/{id}', 'sws_Admin\AdminController@vendornotfeaturemart')->name('vendornotfeaturemart');
...
Route::get('/delete_bank/{id}', 'sws_Admin\AdminController@deleteBankDetails')->name('delete_bank');
...
Route::any('/enquiry/{id?}', 'sws_Admin\CommonController@productEnquirry')->name('enquirry');
Route::any('/delete-enquiry/{id}', 'sws_Admin\CommonController@delete_enquiry')->name('delete_enquiry');
}); 
