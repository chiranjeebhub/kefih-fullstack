...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::get('/colors', 'sws_Admin\AttributeController@colors')->name('colors');
     Route::any('/bulkActivecolor','sws_Admin\AttributeController@bulkActivecolor')->name('bulkActivecolor');
    ...
    Route::any('/bulkActiveSize','sws_Admin\AttributeController@bulkActiveSize')->name('bulkActiveSize');
