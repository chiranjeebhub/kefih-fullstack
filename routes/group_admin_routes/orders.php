...
Route::get('/order_service_invoice/{id}', 'sws_Admin\OrderController@order_ServiceInvoice')->name('order_service_invoice');

Route::get('/razor_pay_check/{id}', 'sws_Admin\OrderController@razorPayCheck')->name('razor_pay_check');
Route::post('/move-to-new/{id}', 'sws_Admin\OrderController@MoveToNewOrder')->name('move-to-new');
...
Route::any('/order_search/{type}/{str}/{daterange}/{vendor}/{a}/{b}', 'sws_Admin\OrderController@index')->name('order_All');
