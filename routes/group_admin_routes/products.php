...
Route::get('/exportProduct_with_Search1/{vendor}/{sts}/{str}/{type}/{category_id}/{brands}/{blocked}','sws_Admin\ProductController@exportProduct')->name('exportProduct_with_Search1');
